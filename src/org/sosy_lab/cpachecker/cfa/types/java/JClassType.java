...
public class JClassType extends JClassOrInterfaceType implements JReferenceType {
   ...
   * @param pStrictFp              if <code>true</code> the class has a strict function pointer, it
   *                               does not otherwise
   * @param pSuperClass            the <code>JClassType</code> object describing the super class of
