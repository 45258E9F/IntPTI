...
public class ASTConverterTest {
  ...
  private final ASTLiteralConverter converter32 =
      new ASTLiteralConverter(MachineModel.LINUX32, Functions.<String>identity());
  private final ASTLiteralConverter converter64 =
      new ASTLiteralConverter(MachineModel.LINUX64, Functions.<String>identity());
  ...
  private String parseIntegerExpression(String pExpression, ASTLiteralConverter pConverter) {
    ...
    return pConverter.parseIntegerLiteral(suffix,
        pExpression.substring(0, pExpression.length() - suffix.getLength()), null).toString();
  }
