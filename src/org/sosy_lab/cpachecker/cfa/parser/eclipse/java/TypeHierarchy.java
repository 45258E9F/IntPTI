...
final class TypeHierarchy {
  ...
  void updateTypeHierarchy(
      AnonymousClassDeclaration pDeclaration, String pFileName,
      LogManager pLogger) {
  ...
  static class THTypeTable {
    ...
    public Map<JClassOrInterfaceType, Set<JMethodDeclaration>> getMethodDeclarationsOfType() {
      ...
      for (Map.Entry<JClassOrInterfaceType, Set<JMethodDeclaration>> entry : methodDeclarationsOfType
          .entrySet()) {
    ...
    public Map<JClassOrInterfaceType, Set<JFieldDeclaration>> getFieldDeclarationsOfType() {
      ...
      for (Map.Entry<JClassOrInterfaceType, Set<JFieldDeclaration>> entry : fieldDeclarationsOfType
          .entrySet()) {
        tmp.put(entry.getKey(), ImmutableSet.copyOf(entry.getValue()));
      }
