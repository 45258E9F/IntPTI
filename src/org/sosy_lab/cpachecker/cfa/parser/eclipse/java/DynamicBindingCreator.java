...
class DynamicBindingCreator {
  ...
  private void completeBindingsForDeclaringInterfaceType(
      JInterfaceType methodDeclaringType,
      String methodName) {
  ...
  private void completeBindingsForDeclaringClassType(
      JClassType methodDeclaringType,
      String methodName) {
  ...
  private void completeBindingsForClass(
      JClassType classType, String methodNametoBeRegistered,
  ...
  private String updateBinding(
      ...
      String methodNametoBeRegistered,
      String methodNameToRegister) {
  ...
  private void createOnlyReferencedMethodInvocationBinding(
    ...
    JReferencedMethodInvocationExpression newFunctionCallExpression =
        (JReferencedMethodInvocationExpression) astCreator
            .convert(onlyFunction, oldFunctionCallExpression);
  ...
  private void createLastBinding(
    ...
    BlankEdge postConditionEdge =
        new BlankEdge(edge.getRawStatement(), edge.getFileLocation(), nextPrevNode,
            postConditionNode, "");
  ...
  private void createConditionEdges(
      CFANode prevNode, CFANode successfulNode,
    ...
    final JExpression exp = astCreator
        .convertClassRunTimeCompileTimeAccord(fileloc, methodInvocation,
            classTypeOfNewMethodInvocation);
  ...
  private void trackOverridenMethods(JMethodDeclaration declaration, FunctionEntryNode entryNode) {
    ...
    final List<JClassOrInterfaceType> declaringClassesSuperTypes =
  ...
  private boolean overrides(
    ...
    if (!firstReturnType.equals(sndReturnType)) {
      ...
      if (!(firstReturnType instanceof JClassOrInterfaceType
          ...
          || !isSubType((JClassOrInterfaceType) firstReturnType,
          (JClassOrInterfaceType) sndReturnType)) {
        return false;
      }
    }
  ...
  private boolean isSubType(
      JClassOrInterfaceType pPossibleSubtype,
      JClassOrInterfaceType pPossibleSuperType) {
    return pPossibleSubtype.getAllSuperTypesOfType().contains(pPossibleSuperType);
  }

  private void registerMethod(
      JMethodDeclaration pMethodDeclaration,
