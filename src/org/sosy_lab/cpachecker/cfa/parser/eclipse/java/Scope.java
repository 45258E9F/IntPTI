...
class Scope {
   ...
   * @param pTypeHierarchy               Type Hierarchy of program created by {@link
   *                                     TypeHierachyCreator}
   * @param pLogger                      a logger
   */
  public Scope(
      String pFullyQualifiedMainClassName, TypeHierarchy pTypeHierarchy,
      LogManager pLogger) {
