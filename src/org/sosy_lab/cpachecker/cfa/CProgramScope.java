...
public class CProgramScope implements Scope {
  ...
  private static final Predicate<CSimpleDeclaration> HAS_NAME =
      new Predicate<CSimpleDeclaration>() {
  ...
  private static final Function<CSimpleDeclaration, String> GET_NAME =
      new Function<CSimpleDeclaration, String>() {
  ...
  private static final Function<CSimpleDeclaration, String> GET_ORIGINAL_QUALIFIED_NAME =
      new Function<CSimpleDeclaration, String>() {
   ...
   *
   * @param cfa the cfa of the program, where single or block of statements are supposed to be
   *            parsed
   */
  public CProgramScope(CFA cfa, LogManager pLogger) {
    ...
    FluentIterable<CSimpleDeclaration> allDcls =
        FluentIterable.from(nodes).transformAndConcat(TO_C_SIMPLE_DECLARATIONS);
  ...
  private static boolean equals(
      @Nullable CType pA,
      @Nullable CType pB,
      Set<Pair<CType, CType>> pResolved) {
  ...
  private static Map<String, CSimpleDeclaration> extractQualifiedDeclarations(
    ...
    Multimap<String, CSimpleDeclaration> qualifiedDeclarationsMultiMap =
        pNonFunctionDcls.index(GET_ORIGINAL_QUALIFIED_NAME);
    ...
    for (Map.Entry<String, Collection<CSimpleDeclaration>> declarationsEntry : qualifiedDeclarationsMultiMap
      ...
      Set<CSimpleDeclaration> duplicateFreeDeclarations =
          from(declarations).transform(new Function<CSimpleDeclaration, CSimpleDeclaration>() {
  ...
  private static Map<String, CComplexType> extractTypes(
      FluentIterable<? extends CSimpleDeclaration> pDcls,
      LogManager pLogger) {
  ...
  private static Map<String, CType> extractTypeDefs(
      FluentIterable<CTypeDeclaration> pTypeDcls,
      LogManager pLogger) {
    ...
    Multimap<String, CTypeDefDeclaration> typeDefDeclarationsMap =
        plainTypeDefs.index(new Function<CTypeDefDeclaration, String>() {
    ...
    for (Map.Entry<String, Collection<CTypeDefDeclaration>> typeDefEntry : typeDefDeclarationsMap
        .asMap().entrySet()) {
      String qualifiedName = typeDefEntry.getKey();
      FluentIterable<CType> types =
          from(typeDefEntry.getValue()).transform(new Function<CTypeDefDeclaration, CType>() {
  ...
  private static Map<String, CSimpleDeclaration> extractUniqueSimpleDeclarations(
    ...
    return Maps.transformEntries(
        Maps.filterEntries(from(pQualifiedDeclarations.values()).index(GET_NAME).asMap(),
        ...
        new Maps.EntryTransformer<String, Collection<CSimpleDeclaration>, CSimpleDeclaration>() {
          ...
          @Override
          public CSimpleDeclaration transformEntry(
              String pArg0,
