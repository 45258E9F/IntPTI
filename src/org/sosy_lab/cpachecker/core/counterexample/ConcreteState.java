...
public final class ConcreteState {
   ...
   *
   * @param pVariables          a map that assigns variables a concrete value, without the need to
   *                            assign a concrete address to a variable.
   * @param pAllocatedMemory    a map that assigns the allocated memory to its name.
   * @param pVariableAddressMap a map that assigns variables along the error path an unique
   *                            address.
