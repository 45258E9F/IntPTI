...
public final class IDExpression extends LeftHandSide {
   ...
   * has to be an lvalue.
   *
   * @param pName         the name of the idExpression, which is the identifier of the primary
   *                      expression in C.
   * @param pFunctionName the name of the function, which holds the scope this lvalue is defined
   *                      in.
   */
