...
public class KInductionInvariantChecker {
   ...
   *                            different solvers, as in most cases this check will use another
   *                            solver than the caller of this method does.)
   * @throws InvalidConfigurationException is thrown if the configuration file for k-induction is
   *                                       not available
   * @throws CPAException                  may be thrown while building the CPAs used for this
   *                                       check
   */
