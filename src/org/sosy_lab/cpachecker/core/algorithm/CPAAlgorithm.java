...
public class CPAAlgorithm implements Algorithm, StatisticsProvider {
  ...
  private static class CPAStatistics implements Statistics {
    ...
    public void printStatistics(
      ...
      out.println();
      out.println(
          "Total time for CPA algorithm:     " + totalTimer + " (Max: " + totalTimer.getMaxTime()
  ...
  public static CPAAlgorithm create(
    ...
    return new CPAAlgorithmFactory(cpa, logger, config, pShutdownNotifier, pIterationListener)
        .newInstance();
  }
  ...
  private boolean handleState(
    ...
    try {
      successors =
          transferRelation.getAbstractSuccessors(state, Lists.<AbstractState>newArrayList(),
              precision);
    } finally {
