...
public final class BMCHelper {
  ...
  public static BooleanFormula createFormulaFor(
    ...
    for (PredicateAbstractState e : AbstractStates
        .projectToType(states, PredicateAbstractState.class)) {
  ...
  public static AlgorithmStatus unroll(
      LogManager pLogger,
      ReachedSet pReachedSet,
      ReachedSetInitializer pInitializer,
      Algorithm pAlgorithm,
      ConfigurableProgramAnalysis pCPA) throws CPAException, InterruptedException {
  ...
  public static void adjustReachedSet(
    ...
    for (AdjustableConditionCPA conditionCPA : CPAs.asIterable(pCPA)
        .filter(AdjustableConditionCPA.class)) {
      if (conditionCPA instanceof ReachedSetAdjustingCPA) {
        ...
        pLogger.log(Level.WARNING,
            "Completely clearing the reached set after condition adjustment due to " + conditionCPA
                .getClass()
