...
public class ProofSlicer {
  ...
  private boolean computeTransferTo(
      final ARGState pred, final CFAEdge edge,
  ...
  private void addTransferSet(
      final CFAEdge edge, Set<String> succVars,
  ...
  private void addAllExceptVar(
      final String varName, final Set<String> toAdd,
  ...
  private void updateCoveredNodes(
      ARGState pCovering, Set<String> varSet,
  ...
  private UnmodifiableReachedSet buildSlicedARG(
      final HashMap<ARGState, Set<String>> pVarMap,
  ...
  private ValueAnalysisState sliceState(
      final ValueAnalysisState vState,
