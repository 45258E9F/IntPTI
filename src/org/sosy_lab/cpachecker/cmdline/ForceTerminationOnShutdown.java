 ...
 */
public class ForceTerminationOnShutdown implements Runnable {
  ...
  private ForceTerminationOnShutdown(
      LogManager pLogger, Thread pMainThread,
   ...
   */
  public static ShutdownRequestListener createShutdownListener(
  ...
  public void run() {
    ...
    if (mainThread.isAlive()) {
      ...
      logger.log(Level.INFO,
          "For your information: CPAchecker is currently hanging because the following threads did not yet terminate:\n",
          buildLiveThreadInfo());
    }
