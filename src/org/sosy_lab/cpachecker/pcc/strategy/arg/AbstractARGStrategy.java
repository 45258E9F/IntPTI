...
public abstract class AbstractARGStrategy extends SequentialReadStrategy {
  ...
  public AbstractARGStrategy(
      Configuration pConfig, LogManager pLogger, PropertyChecker pPropertyChecker,
  ...
  protected boolean checkCertificate(
      ...
      ARGState pRoot,
      @Nullable List<ARGState> incompleteStates)
      throws CPAException, InterruptedException {
  ...
  private boolean checkAndAddSuccessors(
      final ARGState pPredecessor, final ReachedSet pReachedSet,
    ...
    if (!checkSuccessors(pPredecessor, successors, pPrecision)) {
      ...
      if (pIncompleteStates != null) {
        ...
        logger.log(Level.FINER, "State", pPredecessor,
  ...
  protected abstract boolean checkSuccessors(
      ARGState pPredecessor,
      Collection<ARGState> pSuccessors,
      Precision pPrecision) throws InterruptedException, CPAException;
