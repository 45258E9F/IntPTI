...
public class FreemarkerUtil {
  ...
  public static class TemplateBuilder {
     ...
     * Do not use the key {@link TemplateBuilder#DEFAULT_LABELS_KEY} since it will be overridden to
     * hold the labels from the resource bundle.
     *
     * @param key The key.
    ...
    public TemplateRepresentation build() throws IllegalStateException {
      ...
      ResourceBundleModel mdl =
          new ResourceBundleModel(resourceBundle, BeansWrapper.getDefaultInstance());
