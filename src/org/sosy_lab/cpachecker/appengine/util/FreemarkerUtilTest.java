...
public class FreemarkerUtilTest {
  ...
  public void labelsKeyIsNull() throws Exception {
    Throwable exc = null;
    try {
      FreemarkerUtil.templateBuilder().context(new Context()).templateName("foo").labelsKey(null)
          .build();
    } catch (IllegalStateException e) {
      exc = e;
    }
  ...
  public void resourceBundleNameIsNull() throws Exception {
    Throwable exc = null;
    try {
      FreemarkerUtil.templateBuilder().context(new Context()).templateName("foo")
          .resourceBundleName(null).build();
    } catch (IllegalStateException e) {
      exc = e;
    }
