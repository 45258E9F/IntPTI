...
public class TasksetTasksServerResource extends WadlServerResource implements TasksetTasksResource {
  ...
  public Representation createTasksFromJson(Representation entity) {
    ...
    try {
      if (!errors.isEmpty()) {
        ...
        return new StringRepresentation(mapper.writeValueAsString(errors),
      ...
      return new StringRepresentation(mapper.writeValueAsString(taskKeys),
          MediaType.APPLICATION_JSON);
  ...
  public Representation getTasks() {
    ...
    try {
      ...
      return new StringRepresentation(mapper.writeValueAsString(allTasks),
          MediaType.APPLICATION_JSON);
    } catch (JsonProcessingException e) {
      getResponse().setStatus(Status.SERVER_ERROR_INTERNAL);
      return getResponseEntity();
