...
public class LeafExpression<LeafType> extends AbstractExpressionTree<LeafType> {
  ...
  private static final Function<AExpressionStatement, ExpressionTree<AExpression>>
    ...
    if (pStatement instanceof CAssignment) {
      ...
      if (assignment.getRightHandSide() instanceof CExpression) {
        ...
        CBinaryExpression assumeExp =
            pBinaryExpressionBuilder.buildBinaryExpressionUnchecked(pStatement.getFileLocation(),
