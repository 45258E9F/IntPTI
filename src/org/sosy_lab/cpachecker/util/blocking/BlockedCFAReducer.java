...
public class BlockedCFAReducer implements BlockComputer {
  ...
  void printInlinedCfa(
      Map<ReducedNode, Map<ReducedNode, Set<ReducedEdge>>> pInlinedCfa,
      Writer pOut) throws IOException {
    for (Entry<ReducedNode, Map<ReducedNode, Set<ReducedEdge>>> outerEntry : pInlinedCfa
        .entrySet()) {
