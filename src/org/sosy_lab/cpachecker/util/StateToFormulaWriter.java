...
public class StateToFormulaWriter implements StatisticsProvider {
  ...
  public enum FormulaSplitter {
    LOCATION,
    // one formula per location: "(a=2&b=3)|(a=2&b=4)"
    STATE,
    // one formula per state: "a=2&b=3", "a=2&b=4"
   ...
   */
  public void write(
      final CFANode pCfaNode,
      UnmodifiableReachedSet pReachedSet,
      Appendable pAppendable) throws IOException {
  ...
  private void writeFormulas(
      Appendable pAppendable, Set<String> definitions,
