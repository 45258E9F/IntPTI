...
/**
 * The class <code>PredicatePartitionImplication</code> represents a concrete partition of
...
public class PredicatePartitionImplication extends PredicatePartition {
  ...
  /**
   * Inserts a new predicate before the most left predicate of the partition that is implied by the
   * new predicate.
   *
