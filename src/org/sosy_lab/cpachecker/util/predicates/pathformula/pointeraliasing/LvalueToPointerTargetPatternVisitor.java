...
class LvalueToPointerTargetPatternVisitor
  ...
  private class PointerTargetEvaluatingVisitor
    ...
    @Override
    protected PointerTargetPattern visitDefault(final CExpression e)
    ...
    @Override
    public PointerTargetPattern visit(final CPointerExpression e)
        throws UnrecognizedCCodeException {
      return null;
    }
  }
  ...
  @Override
  public PointerTargetPattern visit(final CArraySubscriptExpression e)
      throws UnrecognizedCCodeException {
  ...
  public PointerTargetPattern visit(CFieldReference e) throws UnrecognizedCCodeException {
    ...
    if (result != null) {
      ...
      if (containerType instanceof CCompositeType) {
        ...
        result.shift(containerType,
            ptsMgr.getOffset((CCompositeType) containerType, e.getFieldName()));
        return result;
      } else {
        throw new UnrecognizedCCodeException("Field owner expression has incompatible type",
            cfaEdge, e);
      }
    } else {
      return null;
