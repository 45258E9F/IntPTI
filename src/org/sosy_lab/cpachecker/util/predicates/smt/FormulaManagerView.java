...
public class FormulaManagerView {
  ...
  public FormulaManagerView(
    ...
    final BitvectorFormulaManager rawBitvectorFormulaManager =
        getRawBitvectorFormulaManager(config);
    final FloatingPointFormulaManager rawFloatingPointFormulaManager =
        getRawFloatingPointFormulaManager();

    bitvectorFormulaManager =
        new BitvectorFormulaManagerView(wrappingHandler, rawBitvectorFormulaManager,
            manager.getBooleanFormulaManager());
    floatingPointFormulaManager =
        new FloatingPointFormulaManagerView(wrappingHandler, rawFloatingPointFormulaManager);
    integerFormulaManager =
        new IntegerFormulaManagerView(wrappingHandler, getIntegerFormulaManager0());
   ...
   */
  private BitvectorFormulaManager getRawBitvectorFormulaManager(Configuration config)
    ...
    switch (encodeBitvectorAs) {
      case BITVECTOR:
        try {
          ...
          throw new InvalidConfigurationException(
              "The chosen SMT solver does not support the theory of bitvectors, "
        ...
        break;
      case INTEGER:
        rawBitvectorFormulaManager =
            new ReplaceBitvectorWithNumeralAndFunctionTheory<>(wrappingHandler,
                manager.getBooleanFormulaManager(),
      ...
      case RATIONAL:
        ...
        try {
          ...
          throw new InvalidConfigurationException(
              "The chosen SMT solver does not support the theory of rationals, "
                  + "please choose another SMT solver "
                  + "or use the option cpa.predicate.encodeBitvectorAs "
                  + "to approximate bitvectors with another theory.",
              e);
  ...
  private NumeralFormulaManager<IntegerFormula, IntegerFormula> getIntegerFormulaManager0() {
    NumeralFormulaManager<IntegerFormula, IntegerFormula> ifmgr =
  ...
  private NumeralFormulaManager<NumeralFormula, RationalFormula> getRationalFormulaManager0() {
    NumeralFormulaManager<NumeralFormula, RationalFormula> rfmgr =
  ...
  public <T extends Formula> BooleanFormula makeModularCongruence(T pF1, T pF2, long pModulo) {
    BooleanFormula t;
    if (pF1 instanceof IntegerFormula && pF2 instanceof IntegerFormula) {
      t = integerFormulaManager
          .modularCongruence((IntegerFormula) pF1, (IntegerFormula) pF2, pModulo);
    } else if (pF1 instanceof NumeralFormula && pF2 instanceof NumeralFormula) {
      t = getRationalFormulaManager()
          .modularCongruence((NumeralFormula) pF1, (NumeralFormula) pF2, pModulo);
    } else if (pF1 instanceof BitvectorFormula && pF2 instanceof BitvectorFormula) {
      t = bitvectorFormulaManager
          .modularCongruence((BitvectorFormula) pF1, (BitvectorFormula) pF2, pModulo);
    } else {
      throw new IllegalArgumentException("Not supported interface");
    }
  ...
  public RationalFormulaManagerView getRationalFormulaManager() {
    if (rationalFormulaManager == null) {
      rationalFormulaManager =
          new RationalFormulaManagerView(wrappingHandler, getRationalFormulaManager0());
    }
  ...
  private <T extends Formula> T myFreeVariableNodeTransformer(
    ...
    FormulaVisitor<Void> process = new FormulaVisitor<Void>() {
      ...
      public Void visitQuantifier(
          BooleanFormula f, Quantifier quantifier,
          List<Formula> args,
          BooleanFormula body) {
  ...
  /**
   * @see FormulaManager#splitNumeralEqualityIfPossible(Formula) for documentation.
   */
  ...
  private Set<String> getDeadFunctionNames(
      BooleanFormula pFormula, SSAMap pSsa,
      boolean extractUFs) {
   ...
   */
  public BooleanFormula quantifyDeadVariables(
      BooleanFormula pF,
      SSAMap pSSAMap) {
