...
public class CFATraversal {
  ...
  public final static class NodeCollectingCFAVisitor extends ForwardingCFAVisitor {
    ...
    /**
     * A Node where the visitor should stop calling the visit methed of its super class. This is
   ...
   * CFAVisitor)}.
   *
   * If any of these method throws an exception, the traversal process is immediately aborted and
