...
public class TestDataTools {
  ...
  public static Pair<CFAEdge, CExpressionAssignmentStatement> makeAssignment(
      CLeftHandSide pLhs,
      CExpression pRhs) {
  ...
  public static Pair<CAssumeEdge, CExpression> makeAssume(
      CExpression pAssumeExr,
      CFANode pPred,
      CFANode pSucc) {
    CAssumeEdge assumeEdge = new CAssumeEdge(
        "dummyassume",
  ...
  public static CFA makeCFA(String cProgram)
  ...
  public static CFA makeCFA(String cProgram, Configuration config)
   ...
   *                           This can be very convenient if the {@link PathFormula}s from
   *                           different calls to this method should be conjoined together.
