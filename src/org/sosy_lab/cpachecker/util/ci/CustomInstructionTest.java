...
public class CustomInstructionTest {
  ...
  @Before
  public void init() throws NoSuchMethodException, SecurityException, InstantiationException,
  ...
  public void testIsStartState()
      throws CPAException, InstantiationException, IllegalAccessException,
  ...
  public void testGetAppliedCustomInstruction() throws IllegalArgumentException, CPAException {
    ...
    try {
      ...
      Truth.assertThat(e).isInstanceOf(CPAException.class);
      Truth.assertThat(e)
          .hasMessage("The state does not represent start of known custom instruction");
    }
  ...
  public void testGetFakeSMTDescription() {
    ...
    Truth.assertThat(pair.getSecond()).isEqualTo(
        "(define-fun ci() Bool(and (= var 0)(and (= |f::var1| 0)(and (= var2 0)(and (= var3@1 0) (= |f::var4@1| 0))))))");
  }

  @Test
  public void testInspectAppliedCustomInstruction()
      throws AppliedCustomInstructionParsingFailedException,
             InterruptedException, IOException, ParserException, SecurityException,
    ...
    Truth.assertThat(pair.getSecond()).isEqualTo(
        "(define-fun ci() Bool(and (= 7 0)(and (= |main::b| 0)(and (= |main::a@1| 0) (= |main::b@1| 0)))))");
  ...
  public void testGetInputVariables() throws SecurityException, IllegalArgumentException {
    ...
    aci = new AppliedCustomInstruction(startNode, endNodes, inputVariables,
        Collections.<String>emptyList(), inputVariables,
  ...
  public void testGetOutputVariables() {
    ...
    aci = new AppliedCustomInstruction(startNode, endNodes, Collections.<String>emptyList(),
        outputVariables, Collections.<String>emptyList(),
        Pair.of(Collections.<String>emptyList(), ""), SSAMap.emptySSAMap());
  ...
  public void testGetInputVariablesAndConstants() {
    ...
    aci = new AppliedCustomInstruction(startNode, endNodes, Collections.singletonList("main::a"),
        Collections.<String>emptyList(),
    ...
    Truth.assertThat(aci.getInputVariablesAndConstants())
        .containsExactlyElementsIn(inputVarsAndConstants).inOrder();
  }
}
