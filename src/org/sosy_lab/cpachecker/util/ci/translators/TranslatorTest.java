...
public class TranslatorTest {
  ...
  private CSimpleType integervariable =
  ...
  public void testValueTranslator() {
    ...
    constantsMap =
        constantsMap.putAndCopy(MemoryLocation.valueOf("fun::var1"), new NumericValue(1.5));
    constantsMap =
        constantsMap.putAndCopy(MemoryLocation.valueOf("fun::varC"), new NumericValue(-5));
    ...
    listOfIndependentRequirements = vReqTransTest
        .getListOfIndependentRequirements(vStateTest, ssaTest, Collections.<String>emptyList());
  ...
  public void testSignTranslator() {
    ...
    List<String> listOfIndepententReq = sReqTransTest
        .getListOfIndependentRequirements(sStateTest, ssaTest, Collections.<String>emptyList());
  ...
  public void testIntervalAndCartesianTranslator()
    ...
    listOfIndependentRequirements = iReqTransTest
        .getListOfIndependentRequirements(iStateTest, ssaTest, Collections.<String>emptyList());
    Truth.assertThat(listOfIndependentRequirements).isEmpty();
    ...
    Method writeVarDefinition = CartesianRequirementsTranslator.class
        .getDeclaredMethod("writeVarDefinition",
            new Class[]{List.class, SSAMap.class, Collection.class});
    writeVarDefinition.setAccessible(true);
    @SuppressWarnings("unchecked")
    List<String> varDefinition = (List<String>) writeVarDefinition
        .invoke(iReqTransTest, Arrays.asList(varNames), ssaTest, Collections.<String>emptyList());
    Truth.assertThat(varDefinition).isEmpty();

    varDefinition = (List<String>) writeVarDefinition
        .invoke(iReqTransTest, Arrays.asList(varNames), ssaTest, null);
    content = new ArrayList<>();
    ...
    varDefinition = (List<String>) writeVarDefinition
        .invoke(iReqTransTest, Arrays.asList(varNames), ssaTest, requiredVars);
    ...
    Pair<List<String>, String> convertedToFormula =
        iReqTransTest.convertToFormula(iStateTest, ssaTest, Collections.<String>emptyList());
    ...
    s =
        "(define-fun req () Bool (and (and (>= |fun::var1| 0) (<= |fun::var1| 10))(and (>= |fun::varB@1| 8)(and (and (>= |fun::varC| -15) (<= |fun::varC| -3))(and (<= var1@1 5)(and (>= var2 -7)(<= var3@1 -2)))))))";
    Truth.assertThat(convertedToFormula.getSecond()).isEqualTo(s);
  ...
  @Test
  public void testPredicateRequirementsTranslator()
    ...
    AbstractionFormula aFormula =
        new AbstractionFormula(fmv, region, bf, bf, pathFormula, Collections.<Integer>emptySet());
    PredicateAbstractState ptrueState = PredicateAbstractState
        .mkAbstractionState(pathFormula, aFormula,
    ...
    aFormula = new AbstractionFormula(fmv, region, bf1, bfmgr.makeBoolean(true), pathFormula,
        Collections.<Integer>emptySet());
    PredicateAbstractState pf1State = PredicateAbstractState
        .mkAbstractionState(pathFormula, aFormula,
            PathCopyingPersistentTreeMap.<CFANode, Integer>of());
    ...
    aFormula = new AbstractionFormula(fmv, region, bf2, bfmgr.makeBoolean(true), pathFormula,
        Collections.<Integer>emptySet());
    PredicateAbstractState pf2State = PredicateAbstractState
        .mkAbstractionState(pathFormula, aFormula,
            PathCopyingPersistentTreeMap.<CFANode, Integer>of());
    ...
    Pair<Pair<List<String>, String>, Pair<List<String>, String>> convertedRequirements = pReqTrans
        .convertRequirements(pf1State, Collections.<AbstractState>emptyList(), ssaTest, null, null);
    list.clear();
