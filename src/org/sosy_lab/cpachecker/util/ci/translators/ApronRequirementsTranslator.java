...
public class ApronRequirementsTranslator extends CartesianRequirementsTranslator<ApronState> {
  ...
  private
  @Nullable
  String convertConstraintToFormula(
      final Tcons0 constraint, final List<String> varNames,
  ...
  private
  @Nullable
  String convertLeftConstraintPartToFormula(
