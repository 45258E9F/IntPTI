...
public class InvalidReadErrorReport extends DefaultTracedErrorReport
    implements ErrorReportWithTrace {

  private InvalidReadErrorReport(
      @Nullable CAstNode pNode, @Nullable CFAEdge pEdge,
      CheckerWithInstantErrorReport pChecker) {
    super(pNode, pEdge, pChecker);
  }

  public static InvalidReadErrorReport of(
      @Nullable CAstNode pNode, @Nullable CFAEdge pEdge,
      CheckerWithInstantErrorReport pChecker) {
    return new InvalidReadErrorReport(pNode, pEdge, pChecker);
  }
