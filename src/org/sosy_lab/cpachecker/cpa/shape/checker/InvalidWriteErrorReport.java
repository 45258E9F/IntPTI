...
public class InvalidWriteErrorReport extends DefaultTracedErrorReport
    implements ErrorReportWithTrace {

  private InvalidWriteErrorReport(
      @Nullable CAstNode pNode, @Nullable CFAEdge pEdge,
      CheckerWithInstantErrorReport pChecker) {
    super(pNode, pEdge, pChecker);
  }

  public static InvalidWriteErrorReport of(
      @Nullable CAstNode pNode, @Nullable CFAEdge pEdge,
      CheckerWithInstantErrorReport pChecker) {
    return new InvalidWriteErrorReport(pNode, pEdge, pChecker);
  }
