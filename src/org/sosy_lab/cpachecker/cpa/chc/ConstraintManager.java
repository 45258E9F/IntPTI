...
public class ConstraintManager {
  ...
  public static boolean init(
      String firingRelation,
      String generalizationOperator,
      LogManager logM) {

    String initstr[] =
        {"swipl", "-x", "./lib/native/x86_64-linux/chc_lib", "-g", "true", "-nosignals"};
      ...
      switch (bexp.getOperator()) {
        ...
        case DIVIDE:
          for (Pair<Term, ArrayList<Term>> aexpTerm : aexpTerms) {
            ...
            paramAexpTerms
                .add(Pair.of(Util.termArrayToList(new Term[]{paramAexpTerm}), aexpTermVars));
          }
        ...
        case NOT_EQUALS:
          for (Pair<Term, ArrayList<Term>> aexpTerm : aexpTerms) {
            ...
            paramAexpTerms.add(
                Pair.of(Util.termArrayToList(new Term[]{paramAexpTerm, aexpTerm.getFirst()}),
                    aexpTermVars));
            paramAexpTerm =
  ...
  private static Collection<Pair<Term, ArrayList<Term>>> addOperands(
      String operator,
      Collection<Pair<Term, ArrayList<Term>>> operand1,
      Collection<Pair<Term, ArrayList<Term>>> operand2) {
