...
class FunctionPointerTransferRelation extends SingleEdgeTransferRelation {
    ...
    if (functionCallVariable != null) {
      ...
      if (target instanceof NamedFunctionTarget) {
        ...
        logger.logfOnce(Level.WARNING, "%s: Function pointer %s points to %s,"
            ...
            pCfaEdge.getFileLocation(), functionCallVariable, functionName,
  ...
  private void handleStatement(
      FunctionPointerState.Builder pNewState, CStatement pStatement,
  ...
  private void handleFunctionReturn(
      FunctionPointerState.Builder pNewState,
      CFunctionReturnEdge pFunctionReturnEdge) throws UnrecognizedCCodeException {
  ...
  private String getLeftHandSide(CExpression lhsExpression, CFAEdge edge)
    ...
    if (lhsExpression instanceof CIdExpression) {
      ...
      throw new UnrecognizedCCodeException("left operand of assignment has to be a variable", edge,
          lhsExpression);
    }
    return null;
  }
  ...
  private static class ExpressionValueVisitor
      extends DefaultCExpressionVisitor<FunctionPointerTarget, UnrecognizedCCodeException>
    ...
    private ExpressionValueVisitor(
        FunctionPointerState.Builder pElement,
    ...
    private FunctionPointerTarget extractFunctionId(CIdExpression operand) {
      if ((operand.getDeclaration() != null && operand.getDeclaration()
          .getType() instanceof CFunctionType)
    ...
    @Override
    public FunctionPointerTarget visit(CComplexCastExpression pE)
        throws UnrecognizedCCodeException {
