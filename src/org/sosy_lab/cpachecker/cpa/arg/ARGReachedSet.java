...
public class ARGReachedSet {
  ...
  public void removeSubtree(
      ARGState pState, List<Precision> pPrecisions,
  ...
  public void readdToWaitlist(
    ...
    mReached.updatePrecision(state,
        adaptPrecision(mReached.getPrecision(state), precision, pPrecisionType));
  ...
  private Precision adaptPrecision(
      Precision pOldPrecision, Precision pNewPrecision,
      Predicate<? super Precision> pPrecisionType) {
