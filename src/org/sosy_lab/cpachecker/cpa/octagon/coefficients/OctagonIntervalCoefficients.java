...
public class OctagonIntervalCoefficients extends AOctagonCoefficients {
   ...
   */
  public OctagonIntervalCoefficients(
      int size,
      int index,
      OctagonInterval bounds,
      OctagonState oct) {
    super(size, oct);
  ...
  public OctagonIntervalCoefficients expandToSize(int size, OctagonState oct) {
    ...
    newCoeffs.coefficients[newCoeffs.coefficients.length - 1] =
  ...
  public static OctagonIntervalCoefficients getNondetUIntCoeffs(int size, OctagonState oct) {
    ...
    result.coefficients[result.coefficients.length - 1] =
        new OctagonInterval(0, Double.POSITIVE_INFINITY);
    return result;
  }
  ...
  public String toString() {
    ...
    for (int i = 0; i < coefficients.length; i++) {
      ...
      if (i < size) {
        builder
            .append(oct.getVariableToIndexMap().inverse().get(i) + " -> [" + a + ", " + b + "]\n");
      } else {
