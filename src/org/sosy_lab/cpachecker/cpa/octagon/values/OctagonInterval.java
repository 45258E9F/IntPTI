...
public class OctagonInterval {
  ...
  public static final OctagonInterval FALSE =
      new OctagonInterval(OctagonIntValue.ZERO, OctagonIntValue.ZERO);
  ...
  /**
   * This method creates a new OctInterval instance representing the union of this OctInterval with
   * another OctInterval.
   *
   * The lower bound and upper bound of the new OctInterval is the minimum of both lower bounds and
  ...
  /**
   * This method creates a new OctInterval instance representing the intersection of this
   * OctInterval with another OctInterval.
   *
   * The lower bound and upper bound of the new OctInterval is the maximum of both lower bounds and
  ...
  /**
   * This method creates a new OctInterval instance with the lower and upper bounds being the
   * minimum of both the lower and upper bounds, respectively.
   *
   * @param other the other OctInterval
   * @return the new OctInterval with the respective bounds
   */
  ...
  /**
   * This method creates a new OctInterval instance with the lower and upper bounds being the
   * maximum of both the lower and upper bounds, respectively.
   *
   * @param other the other OctInterval
   * @return the new OctInterval with the respective bounds
   */
   ...
   * @return the new OctInterval with the upper bound of this OctInterval and the lower bound set to
   * the maximum of this OctInterval's and the other OctInterval's lower bound or an empty
   * OctInterval if this OctInterval is less than the other OctInterval.
   */
   ...
   *
   * @param other the OctInterval to limit this OctInterval
   * @return the new OctInterval with the lower bound of this OctInterval and the upper bound set to
   * the minimum of this OctInterval's and the other OctInterval's upper bound or an empty
   * OctInterval if this OctInterval is greater than the other OctInterval.
   */
   ...
   *
   * The method still returns true, if the borders match. An empty OctInterval does not contain any
   * OctInterval and is not contained in any OctInterval either. So if the callee or parameter is an
   * empty OctInterval, this method will return false.
   *
   * @param other the other OctInterval
  ...
  /**
   * This method adds an OctInterval from this OctInterval, overflow is handled by setting the bound
  ...
  public OctagonInterval plus(OctagonInterval OctInterval) {
    ...
    return new OctagonInterval(scalarPlus(low, OctInterval.low),
        scalarPlus(high, OctInterval.high));
  }

  /**
   * This method adds a constant offset to this OctInterval, overflow is handled by setting the
  ...
  /**
   * This method subtracts an OctInterval from this OctInterval, overflow is handled by setting the
   * bound to Long.MIN_VALUE or Long.MAX_VALUE respectively.
   *
  ...
  /**
   * This method subtracts a constant offset to this OctInterval, overflow is handled by setting the
   * bound to Long.MIN_VALUE or Long.MAX_VALUE respectively.
   *
  ...
  /**
   * This method multiplies this OctInterval with another OctInterval. In case of an overflow
   * Long.MAX_VALUE and Long.MIN_VALUE are used instead.
   *
   * @param other OctInterval to multiply this OctInterval with
   * @return new OctInterval that represents the result of the multiplication of the two
   * OctIntervals
   */
  ...
  public OctagonInterval times(OctagonInterval other) {
    ...
    return new OctagonInterval(Collections.min(Arrays.asList(values)),
        Collections.max(Arrays.asList(values)));
  }

  /**
   * This method divides this OctInterval by another OctInterval. If the other OctInterval contains
   * "0" an unbound OctInterval is returned.
   *
   ...
   *
   * @return an unbounded OctInterval, i.e. the lower and upper bound are set to Long.MIN_VALUE and
   ...
   *
   * @return an OctInterval representing the FALSE value, i.e. the lower and upper bound are set to
   * 0
   */
