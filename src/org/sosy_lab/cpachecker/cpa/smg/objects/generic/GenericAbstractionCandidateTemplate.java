...
public class GenericAbstractionCandidateTemplate implements SMGObjectTemplate {
   ...
   *
   * The abstraction is generated from two concrete regions of two smgs. One region represents the
   * base object at the end of the abstraction, while the other represents an object in the middle
   * of the abstraction. Based on which pointer they share, that lead to and from these objects, and
   * which pointer they don't share, a simple inductive abstraction is generated.
   *
  ...
  public static GenericAbstractionCandidateTemplate createSimpleInductiveGenericAbstractionTemplate(
    ...
    return new GenericAbstractionCandidateTemplate(sharedFields, sharedIPointer, sharedOPointer,
        nonSharedOPointer, pRoot);
  }
  ...
  public static GenericAbstractionCandidateTemplate valueOf(
    ...
    return new GenericAbstractionCandidateTemplate(
        ImmutableMap.copyOf(abstractPointerToMaterlisationSteps));
  }
