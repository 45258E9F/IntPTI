...
public class PredRelation {
   ...
   */
  private final SetMultimap<Pair<Integer, Integer>, SymbolicRelation> smgValuesRelation =
      HashMultimap.create();
  private final SetMultimap<Integer, Integer> smgValuesDependency = HashMultimap.create();
  private final SetMultimap<Integer, ExplicitRelation> smgExplicitValueRelation =
      HashMultimap.create();
  ...
  public void addExplicitRelation(
      Integer pSymbolicValue, SMGExplicitValue pExplicitValue,
      BinaryOperator pOp) {
