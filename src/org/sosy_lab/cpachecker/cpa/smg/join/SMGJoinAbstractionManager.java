...
public class SMGJoinAbstractionManager {
  ...
  public SMGJoinAbstractionManager(
      SMGObject pRootInSMG1, SMGObject pRootInSMG2, SMG pInputSMG1,
  ...
  private Optional<GenericAbstractionCandidateTemplate> calculateSimpleTemplateAbstractionFromObject() {
    ...
    Triple<Set<Pair<SMGEdgeHasValue, SMGEdgeHasValue>>, Set<SMGEdgeHasValue>, Set<SMGEdgeHasValue>>
        ...
        assignToSharedPPointerAndNonSharedOPointerAndSharedNonPointer(fieldsOfObject1,
            fieldsOfObject2);
  ...
  private Pair<Set<Pair<SMGEdgePointsTo, SMGEdgePointsTo>>, Set<SMGEdgePointsTo>> assignToSharedIPointerAndNonSharedIPointer(
    ...
    Map<Integer, SMGEdgePointsTo> offsetToPte1Map =
        FluentIterable.from(pInboundPointers1)
    ...
    Map<Integer, SMGEdgePointsTo> offsetToPte2Map =
        FluentIterable.from(pInboundPointers2)
            .uniqueIndex(new Function<SMGEdgePointsTo, Integer>() {
