...
public class SMGJoinMatchObjectsTest {
  ...
  public void nullObjectTest() {
    SMGJoinMatchObjects mo =
        new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, null, null, smg1.getNullObject(),
            smg2.getNullObject());
    Assert.assertFalse(mo.isDefined());

    smg1.addObject(srcObj1);
    mo = new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, null, null, srcObj1,
        smg2.getNullObject());
    Assert.assertFalse(mo.isDefined());
  }
  ...
  public void inconsistentMappingTest() {
    ...
    SMGJoinMatchObjects mo =
        new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, mapping1, mapping2, srcObj1,
            srcObj2);
    Assert.assertFalse(mo.isDefined());
  }
  ...
  public void inconsistentObjectsTest() {
    ...
    mo = new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, mapping1, mapping2, srcObj1,
        srcObj2);
    Assert.assertFalse(mo.isDefined());
  }
  ...
  public void fieldInconsistencyTest() {
    ...
    SMGEdgeHasValue hv1 =
        new SMGEdgeHasValue(mockType2b, 0, srcObj1, SMGValueFactory.getNewValue());
    SMGEdgeHasValue hv2 =
        new SMGEdgeHasValue(mockType2b, 2, srcObj2, SMGValueFactory.getNewValue());
    SMGEdgeHasValue hvMatching1 =
        new SMGEdgeHasValue(mockType2b, 4, srcObj1, SMGValueFactory.getNewValue());
    SMGEdgeHasValue hvMatching2 =
        new SMGEdgeHasValue(mockType2b, 4, srcObj2, SMGValueFactory.getNewValue());
  ...
  public void oneAbstractionTest() {
    ...
    SMGJoinMatchObjects mo =
        new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, mapping1, mapping2, sll,
            prototype);
    Assert.assertTrue(mo.isDefined());
    Assert.assertEquals(SMGJoinStatus.LEFT_ENTAIL, mo.getStatus());

    mo = new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, mapping1, mapping2, prototype,
        sll);
    Assert.assertTrue(mo.isDefined());
    Assert.assertEquals(SMGJoinStatus.RIGHT_ENTAIL, mo.getStatus());
  }
  ...
  public void noAbstractionTest() {
    ...
    SMGJoinMatchObjects mo =
        new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, mapping1, mapping2, object,
            object);
    Assert.assertTrue(mo.isDefined());
    Assert.assertEquals(SMGJoinStatus.EQUAL, mo.getStatus());
  }
