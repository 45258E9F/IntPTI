...
public class SMGJoinTargetObjectsTest {
  ...
  public void matchingObjectsWithoutMappingTest() throws SMGInconsistentException {
    ...
    SMGJoinTargetObjects jto =
        new SMGJoinTargetObjects(SMGJoinStatus.EQUAL, smg1, smg2, destSMG, mapping1, mapping2,
            value1, value2, 0, 0, 0, false, false);
  ...
  public void matchingObjectsWithMappingTest() throws SMGInconsistentException {
    ...
    SMGJoinMatchObjects mo =
        new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, mapping1, mapping2, obj1, obj2);
    Assert.assertTrue(mo.isDefined());

    new SMGJoinTargetObjects(mo.getStatus(), smg1, smg2, destSMG, mapping1, mapping2, value1,
        value2, 0, 0, 0, false, false);
  }
  ...
  public void nonMatchingObjectsTest() throws SMGInconsistentException {
    ...
    SMGJoinMatchObjects mo =
        new SMGJoinMatchObjects(SMGJoinStatus.EQUAL, smg1, smg2, mapping1, mapping2, obj1,
            smg2.getNullObject());
    Assert.assertFalse(mo.isDefined());
    SMGJoinTargetObjects jto =
        new SMGJoinTargetObjects(SMGJoinStatus.EQUAL, smg1, smg2, destSMG, mapping1, mapping2,
            value1, smg2.getNullValue(), 0, 0, 0, false, false);
  ...
  public void joinTargetObjectsDifferentOffsets() throws SMGInconsistentException {
    ...
    SMGJoinTargetObjects jto = new SMGJoinTargetObjects(SMGJoinStatus.EQUAL, smg1, smg2, null, null,
        null, value1, value2, 0, 0, 0, false, false);
  ...
  public void joinTargetObjectsAlreadyJoinedNull() throws SMGInconsistentException {
    ...
    SMGJoinMapTargetAddress mta =
        new SMGJoinMapTargetAddress(new SMG(smg1), new SMG(destSMG), new SMGNodeMapping(mapping1),
