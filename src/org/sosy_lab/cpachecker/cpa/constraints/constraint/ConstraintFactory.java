...
public class ConstraintFactory {
  ...
  private ConstraintFactory(
      String pFunctionName, ValueAnalysisState pValueState, MachineModel pMachineModel,
  ...
  public static ConstraintFactory getInstance(
      String pFunctionName, ValueAnalysisState pValueState,
  ...
  private Constraint transformValueToConstraint(
      SymbolicExpression pExpression,
      Type expressionType) {
    ...
    if (isNumeric(expressionType)) {
      ...
      return createEqual(pExpression, getTrueValueConstant(), expressionType,
          pExpression.getType());
  ...
  private Constraint createEqual(
      SymbolicExpression pLeftOperand, SymbolicExpression pRightOperand,
