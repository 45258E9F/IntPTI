...
public class PolicyIterationManager implements IPolicyIterationManager {
   ...
   * @return Initial state for the analysis, assuming the first node is {@code pNode}.
   */
  @Override
   ...
   * <p/>
   * Returns true iff the <code>node</code> is a loophead and at least one of the bounds in
   * <code>updated</code> has an associated edge coming from outside of the loop. Note that the
   * function returns <code>false</code> is <code>updated</code> is empty.
   */
   ...
   * @return Whether to compute the abstraction when creating a new state associated with
   * <code>node</code>.
   */
