...
public class ValueDeterminationManager {
   ...
   *
   *                         The abstract state associated with the <code>focusedNode</code> is the
   *                         <b>new</b> state, with <code>updated</code> applied.
   * @return Global constraint for value determination and table <code>(template + location) ->
   * formula</code> denoting the abstract value.
   */
