...
final class ImpactUtility {
   ...
   *                        (so it is not the abstraction of s, but the abstraction of the last
   *                        predecessor of s that is an abstraction state). This may be null if
   *                        {@link #requiresPreviousBlockAbstraction()} returns false.
