...
public class PredicateCPA
  ...
  protected PredicateCPA(
    ...
    PathFormulaManager pfMgr =
        new PathFormulaManagerImpl(formulaManager, config, logger, shutdownNotifier, cfa,
            direction);
    if (useCache) {
    ...
    precisionBootstraper =
        new PredicatePrecisionBootstrapper(config, logger, cfa, abstractionManager, formulaManager);
