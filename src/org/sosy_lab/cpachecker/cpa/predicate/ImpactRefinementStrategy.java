...
class ImpactRefinementStrategy extends RefinementStrategy {
  ...
  private class Stats implements Statistics {
    ...
    public void printStatistics(PrintStream out, Result pResult, ReachedSet pReached) {
      ...
      out.println();
      out.println("Number of abstractions during refinements:  " + impact.abstractionTime
  ...
  protected ImpactRefinementStrategy(
      final Configuration config, final Solver pSolver,
   ...
   */
  @Override
  protected boolean performRefinementForState(
      BooleanFormula itp,
