 ...
 * ^ |                           |                                     | BAMBasedRefiner
 * --->    PredicateCPARefiner  --->   BAMPredicateAbstractionRefinementStrategy
 *
...
public abstract class BAMPredicateRefiner implements Refiner {
  ...
  private static final class BAMBlockFormulaStrategy extends BlockFormulaStrategy {
    ...
    private PathFormula rebuildStateAfterFunctionCall(
        final PathFormula parentFormula, final PathFormula rootFormula,
        final FunctionExitNode functionExitNode) {
      final SSAMap newSSA = BAMPredicateReducer
          .updateIndices(rootFormula.getSsa(), parentFormula.getSsa(), functionExitNode);
  ...
  private static class BAMPredicateAbstractionRefinementStrategy
    ...
    public void performRefinement(
      ...
      // we try to improve the reduce-operator by refining the relevantPredicatesComputer.
        ...
        if (relevantPredicatesComputer instanceof RefineableRelevantPredicatesComputer) {
          ...
          RelevantPredicatesComputer newRelevantPredicatesComputer =
              refineRelevantPredicatesComputer(abstractionStatesTrace, pReached,
      ...
      super.performRefinement(pReached, abstractionStatesTrace, pInterpolants,
    ...
    private RelevantPredicatesComputer refineRelevantPredicatesComputer(
        List<ARGState> abstractionStatesTrace, ARGReachedSet pReached,
        RefineableRelevantPredicatesComputer relevantPredicatesComputer) {
