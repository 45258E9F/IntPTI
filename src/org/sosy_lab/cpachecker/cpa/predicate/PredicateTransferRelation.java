...
public class PredicateTransferRelation extends SingleEdgeTransferRelation {
  ...
  public Collection<? extends AbstractState> getAbstractSuccessorsForEdge(
      AbstractState pElement, List<AbstractState> otherStates, Precision pPrecision, CFAEdge edge)
  ...
  private boolean unsatCheck(
      final AbstractionFormula lastAbstraction,
      final PathFormula pathFormulaFromLastAbstraction)
    ...
    try {
      ...
      for (AbstractState lElement : otherElements) {
        ...
        if (!ignoreStateAssumptions && lElement instanceof AbstractStateWithAssumptions) {
          element =
              strengthen(edge.getSuccessor(), element, (AbstractStateWithAssumptions) lElement);
        }
  ...
  private PredicateAbstractState strengthen(
      CFANode pNode, PredicateAbstractState pElement,
      AbstractStateWithAssumptions pAssumeElement)
      throws CPATransferException, InterruptedException {
  ...
  private PredicateAbstractState strengthen(
      PredicateAbstractState pElement,
  ...
  private PredicateAbstractState replacePathFormula(
      PredicateAbstractState oldElement,
  ...
  boolean areAbstractSuccessors(
      AbstractState pElement, CFAEdge pCfaEdge,
    ...
    for (AbstractState e : pSuccessors) {
      ...
      if (successor.isAbstractionState()) {
        ...
        if (mergeWithPathFormula != null) {
          computedPathFormulae
              .put(successor, pathFormulaManager.makeOr(mergeWithPathFormula, computedPathFormula));
        } else {
