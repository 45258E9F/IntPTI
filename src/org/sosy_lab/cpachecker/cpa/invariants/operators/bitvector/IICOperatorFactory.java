...
public enum IICOperatorFactory {
  ...
  public Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval> getAdd(
    ...
    return new Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval>() {
      ...
      public CompoundBitVectorInterval apply(
          ...
          BitVectorInterval pSecondOperand) {
        return CompoundBitVectorInterval
            .of(IIIOperatorFactory.INSTANCE.getAdd(pAllowSignedWrapAround, pOverflowEventHandler)
                .apply(pFirstOperand, pSecondOperand));
      }
    };
  }

  public Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval> getDivide(
      final boolean pAllowSignedWrapAround,
      final OverflowEventHandler pOverflowEventHandler) {
    return new Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval>() {
      ...
      public CompoundBitVectorInterval apply(
        ...
        BitVectorInterval result =
            IIIOperatorFactory.INSTANCE.getDivide(pAllowSignedWrapAround, pOverflowEventHandler)
                .apply(pFirstOperand, pSecondOperand);
        return result == null
  ...
  public Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval> getModulo(
      final boolean pAllowSignedWrapAround,
      final OverflowEventHandler pOverflowEventHandler) {
    return new Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval>() {
  ...
  public Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval> getMultiply(
      final boolean pAllowSignedWrapAround,
      final OverflowEventHandler pOverflowEventHandler) {
    return new Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval>() {
      ...
      public CompoundBitVectorInterval apply(
          BitVectorInterval pFirstOperand,
          BitVectorInterval pSecondOperand) {
        return CompoundBitVectorInterval.of(IIIOperatorFactory.INSTANCE
  ...
  public Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval> getShiftLeft(
      final boolean pAllowSignedWrapAround,
      final OverflowEventHandler pOverflowEventHandler) {
    return new Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval>() {
      ...
      public CompoundBitVectorInterval apply(
        ...
        if (pSecondOperand.containsNegative()
            ...
            BitVectorInterval.singleton(bitVectorInfo, BigInteger.valueOf(bitVectorInfo.getSize()))
                .extendToMaxValue())) {
         ...
         */
        if (pSecondOperand.containsPositive()) {
          BitVectorInterval posPart = pSecondOperand.intersectWith(BitVectorInterval
              .cast(pFirstOperand.getBitVectorInfo(), BigInteger.ONE, pAllowSignedWrapAround,
                  pOverflowEventHandler).extendToMaxValue());
          /*
           * Shift this interval by the lower bound, then by the upper bound of
           * the positive part and span over the results.
           */
          CompoundBitVectorInterval posPartResult = ISCOperatorFactory.INSTANCE
              .getShiftLeft(pAllowSignedWrapAround, pOverflowEventHandler)
              .apply(pFirstOperand, posPart.getLowerBound());

          posPartResult = CompoundBitVectorInterval.span(posPartResult, ISCOperatorFactory.INSTANCE
              .getShiftLeft(pAllowSignedWrapAround, pOverflowEventHandler)
  ...
  public Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval> getShiftRight(
      final boolean pAllowSignedWrapAround,
      final OverflowEventHandler pOverflowEventHandler) {
    return new Operator<BitVectorInterval, BitVectorInterval, CompoundBitVectorInterval>() {
