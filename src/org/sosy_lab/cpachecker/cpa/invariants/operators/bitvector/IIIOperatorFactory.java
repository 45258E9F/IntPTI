...
public enum IIIOperatorFactory {
    ...
    return new Operator<BitVectorInterval, BitVectorInterval, BitVectorInterval>() {
      ...
      public BitVectorInterval apply(BitVectorInterval pOperand1, BitVectorInterval pOperand2) {
        ...
        return BitVectorInterval
            .cast(pOperand1.getBitVectorInfo(), lowerBound, upperBound, pAllowSignedWrapAround,
  ...
  public Operator<BitVectorInterval, BitVectorInterval, BitVectorInterval> getDivide(
    ...
    return new Operator<BitVectorInterval, BitVectorInterval, BitVectorInterval>() {
      ...
      public
      @Nullable
      BitVectorInterval apply(BitVectorInterval pFirstOperand, BitVectorInterval pSecondOperand) {
  ...
  public Operator<BitVectorInterval, BitVectorInterval, BitVectorInterval> getMultiply(
    ...
    return new Operator<BitVectorInterval, BitVectorInterval, BitVectorInterval>() {
      ...
      public BitVectorInterval apply(
        ...
        BitVectorInterval result = BitVectorInterval
            .cast(pFirstOperand.getBitVectorInfo(), lowerBound, upperBound, pAllowSignedWrapAround,
                pOverflowEventHandler);
  ...
  public Operator<BitVectorInterval, BitVectorInterval, BitVectorInterval> getShiftLeft(
    ...
    return new Operator<BitVectorInterval, BitVectorInterval, BitVectorInterval>() {
      ...
      public BitVectorInterval apply(
         ...
         */
        if (pSecondOperand.containsPositive()) {
          BitVectorInterval posPart = pSecondOperand.intersectWith(
              BitVectorInterval.singleton(pFirstOperand.getBitVectorInfo(), BigInteger.ONE)
                  .extendToMaxValue());
          BitVectorInterval posPartResult = ISIOperatorFactory.INSTANCE
  ...
  private static void checkBitVectorCompatibility(
      ...
      BitVectorInterval pSecondOperand) {
    Preconditions
        .checkArgument(pFirstOperand.getBitVectorInfo().equals(pSecondOperand.getBitVectorInfo()),
