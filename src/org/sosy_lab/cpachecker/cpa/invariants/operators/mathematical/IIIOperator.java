...
public enum IIIOperator implements Operator<SimpleInterval, SimpleInterval, SimpleInterval> {
    ...
    public SimpleInterval apply(SimpleInterval pFirstOperand, SimpleInterval pSecondOperand) {
      ...
      if (pSecondOperand.containsPositive()) {
        ...
        if (posPart.hasUpperBound()) {
          posPartResult = SimpleInterval.span(posPartResult,
  ...
  private static
  @Nullable
  BigInteger max(@Nullable BigInteger first, @Nullable BigInteger second) {
    if (first == null) {
      return second;
    } else if (second == null) {
      return first;
  ...
  private static
  @Nullable
  BigInteger min(@Nullable BigInteger first, @Nullable BigInteger second) {
    if (first == null) {
      return second;
    } else if (second == null) {
      return first;
