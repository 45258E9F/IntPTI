...
public enum IICOperator
  ...
  DIVIDE {
    ...
    public CompoundMathematicalInterval apply(
      ...
      return CompoundMathematicalInterval
          .of(IIIOperator.DIVIDE.apply(pFirstOperand, pSecondOperand));
    }
  ...
  MULTIPLY {
    ...
    public CompoundMathematicalInterval apply(
        ...
        SimpleInterval pSecondOperand) {
      return CompoundMathematicalInterval
          .of(IIIOperator.MULTIPLY.apply(pFirstOperand, pSecondOperand));
    }
  ...
  SHIFT_LEFT {
    ...
    public CompoundMathematicalInterval apply(
       ...
       */
      if (pSecondOperand.containsNegative()) {
        SimpleInterval negPart = pSecondOperand.intersectWith(
       ...
       */
      if (pSecondOperand.containsPositive()) {
        SimpleInterval posPart = pSecondOperand
            .intersectWith(SimpleInterval.singleton(BigInteger.ONE).extendToPositiveInfinity());
        /*
        ...
        if (posPart.hasUpperBound()) {
          posPartResult = CompoundMathematicalInterval.span(posPartResult,
    ...
    public CompoundMathematicalInterval apply(
      ...
      if (pSecondOperand.containsPositive()) {
        ...
        if (posPart.hasUpperBound()) {
          ...
          posPartResult = CompoundMathematicalInterval
              .span(posPartResult, CompoundMathematicalInterval.singleton(BigInteger.ZERO));
        }
        result = result.unionWith(posPartResult);
      }
      return result;
