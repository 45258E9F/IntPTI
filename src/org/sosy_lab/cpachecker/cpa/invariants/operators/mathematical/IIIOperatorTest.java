...
public class IIIOperatorTest {
  ...
  public void testModulo() {
    ...
    assertEquals(twoToThree,
        IIIOperator.MODULO.apply(tenToEleven, SimpleInterval.singleton(scalarFour)));
    assertEquals(zeroToTwo,
        IIIOperator.MODULO.apply(eightToTen, SimpleInterval.singleton(scalarFour)));
    assertEquals(twoToThree,
        IIIOperator.MODULO.apply(tenToEleven, SimpleInterval.singleton(scalarFour).negate()));
    assertEquals(zeroToTwo,
        IIIOperator.MODULO.apply(eightToTen, SimpleInterval.singleton(scalarFour).negate()));
    assertEquals(twoToThree.negate(),
        IIIOperator.MODULO.apply(tenToEleven.negate(), SimpleInterval.singleton(scalarFour)));
    assertEquals(zeroToTwo.negate(),
        IIIOperator.MODULO.apply(eightToTen.negate(), SimpleInterval.singleton(scalarFour)));
    assertEquals(twoToThree.negate(), IIIOperator.MODULO
        .apply(tenToEleven.negate(), SimpleInterval.singleton(scalarFour).negate()));
    assertEquals(zeroToTwo.negate(), IIIOperator.MODULO
        .apply(eightToTen.negate(), SimpleInterval.singleton(scalarFour).negate()));
    assertEquals(zeroToFour,
        IIIOperator.MODULO.apply(zeroToInf, SimpleInterval.of(BigInteger.ZERO, scalarFive)));
    assertEquals(zeroToFour,
    ...
    assertEquals(zeroToFour.negate(), IIIOperator.MODULO
        .apply(zeroToInf.negate(), SimpleInterval.of(BigInteger.ZERO, scalarFive)));
    assertEquals(zeroToFour.negate(), IIIOperator.MODULO
        .apply(zeroToInf.negate(), SimpleInterval.of(scalarFour.negate(), scalarFive)));
    assertEquals(zeroToFour.negate(), IIIOperator.MODULO
        .apply(zeroToInf.negate(), SimpleInterval.of(scalarFive.negate(), scalarFour)));
    assertEquals(SimpleInterval.of(scalarFour.negate(), scalarFour), IIIOperator.MODULO
        .apply(SimpleInterval.infinite(), SimpleInterval.of(scalarFive.negate(), scalarFour)));
  ...
  public void testMultiply() {
    ...
    assertEquals(SimpleInterval.infinite(),
        IIIOperator.MULTIPLY.apply(SimpleInterval.infinite(), zeroToOne));
  ...
  public void testDivide() {
    ...
    assertEquals(SimpleInterval.infinite(),
        IIIOperator.DIVIDE.apply(SimpleInterval.infinite(), SimpleInterval.infinite()));
    assertNull(IIIOperator.DIVIDE
        .apply(SimpleInterval.infinite(), SimpleInterval.singleton(BigInteger.ZERO)));
    assertEquals(SimpleInterval.infinite(), IIIOperator.DIVIDE
        .apply(SimpleInterval.infinite(), SimpleInterval.singleton(BigInteger.valueOf(5))));
    assertEquals(SimpleInterval.infinite(), IIIOperator.DIVIDE
        .apply(SimpleInterval.infinite(), SimpleInterval.singleton(BigInteger.valueOf(-5))));
    assertEquals(zeroToInf,
        IIIOperator.DIVIDE.apply(zeroToInf, SimpleInterval.singleton(BigInteger.valueOf(5))));
    assertEquals(negInfToZero,
        IIIOperator.DIVIDE.apply(zeroToInf, SimpleInterval.singleton(BigInteger.valueOf(-5))));
