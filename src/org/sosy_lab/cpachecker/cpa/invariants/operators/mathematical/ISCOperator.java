...
public enum ISCOperator
  ...
  DIVIDE {
    ...
    public CompoundMathematicalInterval apply(
        SimpleInterval pFirstOperand,
        BigInteger pSecondOperand) {
      return CompoundMathematicalInterval
          .of(ISIOperator.DIVIDE.apply(pFirstOperand, pSecondOperand));
    }
  ...
  MODULO {
    ...
    public CompoundMathematicalInterval apply(SimpleInterval pFirstOperand, BigInteger pValue) {
      ...
      if (pFirstOperand.isSingleton()) {
        return CompoundMathematicalInterval
            .singleton(pFirstOperand.getLowerBound().remainder(pValue));
      }
      ...
      if (pFirstOperand.containsNegative()) {
        CompoundMathematicalInterval negRange = CompoundMathematicalInterval
            .of(SimpleInterval.of(largestPossibleValue.negate(), BigInteger.ZERO));
      ...
      if (pFirstOperand.containsPositive()) {
        CompoundMathematicalInterval posRange = CompoundMathematicalInterval
            .of(SimpleInterval.of(BigInteger.ZERO, largestPossibleValue));
        if (pFirstOperand.hasUpperBound()) {
          ...
          if (posPartLength.compareTo(pValue) < 0) {
            ...
            if (modBorder.compareTo(posPart.getLowerBound()) <= 0
              ...
              posRange = CompoundMathematicalInterval
                  .of(SimpleInterval.of(bound1.min(bound2), bound1.max(bound2)));
  ...
  MULTIPLY {
    ...
    public CompoundMathematicalInterval apply(
        ...
        BigInteger pSecondOperand) {
      return CompoundMathematicalInterval
          .of(ISIOperator.MULTIPLY.apply(pFirstOperand, pSecondOperand));
    }
  ...
  SHIFT_LEFT {
    ...
    public CompoundMathematicalInterval apply(
        ...
        BigInteger pSecondOperand) {
      return CompoundMathematicalInterval
          .of(ISIOperator.SHIFT_LEFT.apply(pFirstOperand, pSecondOperand));
    }
  ...
  SHIFT_RIGHT {
    ...
    public CompoundMathematicalInterval apply(
        ...
        BigInteger pSecondOperand) {
      return CompoundMathematicalInterval
          .of(ISIOperator.SHIFT_RIGHT.apply(pFirstOperand, pSecondOperand));
    }
