    ...
    public AbstractionStrategy createStrategy(
      ...
      return new AbstractionStrategy() {
        ...
        private AbstractionState from(
            final AbstractionState pPrevious,
            final boolean pWithEnteringEdges) {
          class EnteringEdgesBasedAbstractionState implements AbstractionState {
            ...
            private EnteringEdgesBasedAbstractionState(
              ...
              this(Collections.<CFAEdge>emptySet(), pPreviousWideningTargets,
                ...
                if (lastEdge.getEdgeType() == CFAEdgeType.FunctionReturnEdge) {
                      ...
                      if (enteringEdge.getEdgeType() != CFAEdgeType.FunctionCallEdge) {
                        ...
                        if (visited.add(newSucc)) {
                          if (enteringEdge.getEdgeType() == CFAEdgeType.FunctionReturnEdge) {
                            successors.add(((FunctionReturnEdge) enteringEdge).getSummaryEdge()
                                .getPredecessor());
                          } else {
                  ...
                  if (summaryEdge != null) {
                    ...
                    if (functionCall instanceof AFunctionCallAssignmentStatement) {
                      ...
                      wideningTargets.addAll(edgeAnalyzer
                          .getInvolvedVariableTypes(assignmentStatement.getLeftHandSide(),
                              summaryEdge).keySet());
                      continue;
                    }
                  }
                ...
                if (!CompoundIntervalFormulaManager.collectVariableNames(hint).isEmpty()) {
                  if (hint instanceof LogicalNot) {
                    ...
                    if (hint instanceof Equal) {
                      ...
                      CompoundIntervalManager cim = pCompoundIntervalManagerFactory
                          .createCompoundIntervalManager(bitVectorInfo);
                      if (op1 instanceof Constant) {
                        NumeralFormula<CompoundInterval> newOp1 =
                            InvariantsFormulaManager.INSTANCE.asConstant(bitVectorInfo,
                                cim.add(
            ...
            public AbstractionState join(AbstractionState pOther) {
              ...
              if (pOther instanceof EnteringEdgesBasedAbstractionState) {
                EnteringEdgesBasedAbstractionState other =
                    (EnteringEdgesBasedAbstractionState) pOther;
                if ((this.visitedEdges == other.visitedEdges || other.visitedEdges
                    .containsAll(this.visitedEdges))
                    && (this.wideningTargets == other.wideningTargets || other.wideningTargets
                    .containsAll(this.wideningTargets))
                    && (this.wideningHints == other.wideningHints || other.wideningHints
                    .containsAll(this.wideningHints))) {
                  return other;
                }
            ...
            public String toString() {
              return String.format("Widening targets: %s; Visited edges: %s", wideningTargets,
          ...
          return new EnteringEdgesBasedAbstractionState(previousWideningTargets,
              previousWideningHints);
        }
