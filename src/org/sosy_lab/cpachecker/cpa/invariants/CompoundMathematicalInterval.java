...
public class CompoundMathematicalInterval implements CompoundInterval {
  ...
  private static final CompoundMathematicalInterval ONE =
      new CompoundMathematicalInterval(SimpleInterval.singleton(BigInteger.ONE));
   ...
   */
  private static final CompoundMathematicalInterval TOP =
      new CompoundMathematicalInterval(SimpleInterval.infinite());
  ...
  public List<CompoundMathematicalInterval> splitIntoIntervals() {
    return Lists.transform(Arrays.asList(this.intervals),
        new Function<SimpleInterval, CompoundMathematicalInterval>() {
  ...
  public CompoundMathematicalInterval unionWith(CompoundMathematicalInterval pOther) {
    if (pOther == this || isTop() || pOther.isBottom()) {
      return this;
    }
    if (pOther.isTop() || isBottom()) {
      return pOther;
    }
      ...
      if (!inserted) {
        if (pOther.touches(lastInterval)) {
          ...
          if (!pOther.hasLowerBound()
              || (interval.hasLowerBound() && less(pOther.getLowerBound(),
  ...
  public CompoundMathematicalInterval intersectWith(CompoundMathematicalInterval pOther) {
    if (isBottom() || pOther.isTop() || this == pOther) {
      return this;
    }
    if (isTop() || pOther.isBottom()) {
      return pOther;
    }
   ...
   * @return <code>true</code> if the given state is contained in this compound state,
   ...
   * versa. Do not confuse this with negating ({@link #negate()}) the state.
   *
  ...
  public CompoundMathematicalInterval invert() {
    ...
    while (index < this.intervals.length) {
      ...
      result = result.unionWith(createSimpleInterval(currentLowerBound,
  ...
  /**
   * Creates a compound state similar to this state but with a negative infinity lower bound or
   * bottom if this state is bottom.
   *
   * @return a compound state similar to this state but with a negative infinity lower bound or
   * bottom if this state is bottom.
   */
  @Override
  ...
  /**
   * Creates a compound state similar to this state but with a positive infinity upper bound or
   * bottom if this state is bottom.
   *
   * @return a compound state similar to this state but with a positive infinity upper bound or
   * bottom if this state is bottom.
   */
  @Override
   ...
   * representing false if both states do not intersect, top if they do intersect but are not equal
   * singletons and bottom if one of the states is bottom.
   */
   ...
   * or not.
   *
   * @return <code>true</code> if this state definitely evaluates to <code>false</code>,
   * <code>false</code> otherwise.
   */
  @Override
   ...
   * or not.
   *
   * @return <code>true</code> if this state definitely evaluates to <code>true</code>,
   * <code>false</code> otherwise.
   */
  @Override
   ...
   * state, false if all values contained in this state are less than or equal to all values in the
  ...
  public CompoundMathematicalInterval greaterThan(final CompoundMathematicalInterval pState) {
    ...
    if (hasLowerBound() && pState.hasUpperBound()
        && getLowerBound().compareTo(pState.getUpperBound()) > 0) {
      return TRUE;
    }
    if (hasUpperBound() && pState.hasLowerBound()
   ...
   * the given state, false if all values contained in this state are less than all values in the
   * given state, bottom if one of the states is bottom, top otherwise.
   */
  ...
  public CompoundMathematicalInterval binaryAnd(CompoundMathematicalInterval pState) {
      ...
      for (SimpleInterval interval : this.intervals) {
        if (!interval.isSingleton()) {
          ...
          return pState.contains(1)
                 ? CompoundMathematicalInterval
                     .of(SimpleInterval.of(BigInteger.ZERO, BigInteger.ONE))
                 : top();
        }
        result = result
            .unionWith(SimpleInterval.singleton(interval.getLowerBound().and(pState.getValue())));
      }
    } else if (isSingleton()) {
    ...
    if (!result.isSingleton()) {
      ...
      if (smallestUpperBound == null) {
        ...
        range =
            CompoundMathematicalInterval.of(SimpleInterval.of(BigInteger.ZERO, smallestUpperBound));
      }
  ...
  public CompoundMathematicalInterval absolute() {
    ...
    return intersectWith(one().negate().extendToMinValue()).negate()
        .unionWith(intersectWith(zero().extendToMaxValue()));
  }
  ...
  public CompoundMathematicalInterval binaryXor(CompoundMathematicalInterval pState) {
    ...
    if (isSingleton() && pState.isSingleton()) {
      return CompoundMathematicalInterval.singleton(getValue().xor(pState.getValue()));
    }
    if (pState.isSingleton() && pState.containsZero()) {
      return this;
    }
    ...
    if (pState.isSingleton()) {
      ...
      for (SimpleInterval interval : this.intervals) {
        ...
        result = result
            .unionWith(SimpleInterval.singleton(interval.getLowerBound().xor(pState.getValue())));
      }
      return result;
    } else if (isSingleton()) {
  ...
  public CompoundMathematicalInterval binaryOr(CompoundMathematicalInterval pState) {
    ...
    if (pState.isSingleton()) {
      ...
      for (SimpleInterval interval : this.intervals) {
        ...
        result = result
            .unionWith(SimpleInterval.singleton(interval.getLowerBound().or(pState.getValue())));
      }
      return result;
    } else if (isSingleton()) {
   ...
   * represent true or both represent false, bottom if one of the states is bottom, top otherwise.
   */
   ...
   * false if one of the given states represents false, bottom if one of the states is bottom, top
   * otherwise.
   */
  public static CompoundMathematicalInterval logicalAnd(
      CompoundMathematicalInterval p1,
      CompoundMathematicalInterval p2) {
   ...
   * representing false if none of the given states represents true, bottom if one of the states is
   * bottom, top otherwise.
   */
  public static CompoundMathematicalInterval logicalOr(
      CompoundMathematicalInterval p1,
      CompoundMathematicalInterval p2) {
   ...
   * represents true, a state representing false if either both given states represent true or both
   * represent false, bottom if one of the states is bottom, top otherwise.
   */
  public static CompoundMathematicalInterval logicalXor(
      CompoundMathematicalInterval p1,
      CompoundMathematicalInterval p2) {
   ...
   * false if the given state does not contain the false state, bottom if the given state is bottom
   * and a top if the given state contains both true and false.
   */
   ...
   */
  private <T> CompoundMathematicalInterval applyOperationToAllAndUnite(
      Operator<SimpleInterval, T, CompoundMathematicalInterval> pOperator,
      T pOperand) {
    CompoundMathematicalInterval result = bottom();
    for (SimpleInterval interval : this.intervals) {
  ...
  /**
   * Returns the lowest bound of the two given intervals, which might be <code>null</code> for
   * negative infinity.
   *
   ...
   * @return the lowest bound of the two given intervals, which might be <code>null</code> for
   * negative infinity.
   */
  @Nullable
  ...
  /**
   * Returns the highest bound of the two given intervals, which might be <code>null</code> for
   * positive infinity.
   *
   ...
   * @return the highest bound of the two given intervals, which might be <code>null</code> for
   * positive infinity.
   */
  ...
  /**
   * Checks if the first given big integer is less than the second given big integer, non of which
   * may be <code>null</code>.
   *
   * @param first  the reference value.
   * @param second the value the reference value is compared to.
   * @return <code>true</code> if <code>a</code> is less than <code>b</code>, <code>false</code>
   * otherwise.
   */
   ...
   * non of which may be <code>null</code>.
   *
   * @param first  the reference value.
   * @param second the value the reference value is compared to.
   * @return <code>true</code> if <code>a</code> is less than or equal to <code>b</code>,
   * <code>false</code> otherwise.
   */
   ...
   * positive infinity.
   *
   * @param lowerBound the lower bound of the resulting interval. Use <code>null</code> to denote
   *                   negative infinity.
   * @param upperBound the upper bound of the resulting interval. Use <code>null</code> to denote
   *                   positive infinity.
   * @return a simple interval with the given bounds.
   */
  private static SimpleInterval createSimpleInterval(
      @Nullable BigInteger lowerBound,
   ...
   * their highest upper bound.
   */
  public static CompoundMathematicalInterval span(
      CompoundMathematicalInterval pLeftValue,
      CompoundMathematicalInterval pRightValue) {
   ...
   */
  public static CompoundMathematicalInterval union(
      CompoundMathematicalInterval pLeftValue,
      CompoundMathematicalInterval pRightValue) {
