...
public class EdgeAnalyzer {
  ...
  public Map<MemoryLocation, CType> getInvolvedVariableTypes(CFAEdge pCfaEdge) {
    switch (pCfaEdge.getEdgeType()) {
      ...
      case FunctionCallEdge: {
        ...
        for (AParameterDeclaration parameter : functionCallEdge.getSuccessor()
      ...
      case StatementEdge: {
        ...
        if (statement instanceof AExpressionAssignmentStatement) {
          ...
          return getInvolvedVariableTypes(((AExpressionStatement) statement).getExpression(),
              pCfaEdge);
          ...
          Map<MemoryLocation, CType> result = new HashMap<>();
          for (AExpression expression : functionCallStatement.getFunctionCallExpression()
      ...
      case FunctionReturnEdge:
        ...
        if (functionCall instanceof AFunctionCallAssignmentStatement) {
          ...
          if (functionCallExpression != null) {
            ...
            result.putAll(
                getInvolvedVariableTypes(functionCallAssignmentStatement.getLeftHandSide(),
                    pCfaEdge));
            return result;
          }
        }
   ...
   */
  private Map<MemoryLocation, CType> getInvolvedVariableTypes(
      CInitializer pCInitializer,
      CFAEdge pCfaEdge) {
    if (pCInitializer instanceof CDesignatedInitializer) {
      return getInvolvedVariableTypes(((CDesignatedInitializer) pCInitializer).getRightHandSide(),
          pCfaEdge);
    } else if (pCInitializer instanceof CInitializerExpression) {
      return getInvolvedVariableTypes(((CInitializerExpression) pCInitializer).getExpression(),
          pCfaEdge);
