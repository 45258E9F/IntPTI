...
public class BitVectorInterval implements BitVectorType {
  ...
  private BitVectorInterval(BitVectorInfo pInfo, BigInteger pLowerBound, BigInteger pUpperBound) {
    ...
    checkArgument(pLowerBound.compareTo(pInfo.getMinValue()) >= 0,
        "lower bound must fit the bit vector");
    checkArgument(pUpperBound.compareTo(pInfo.getMaxValue()) <= 0,
        "upper bound must fit the bit vector");
   ...
   *
   * @return <code>true</code> if the interval has neither a lower nor an upper bound,
   ...
   *
   * @return <code>true</code> if this interval contains at least one positive value,
   * <code>false</code> otherwise.
   */
   ...
   *
   * @return <code>true</code> if this interval contains at least one negative value,
   * <code>false</code> otherwise.
   */
   ...
   *
   * @return <code>true</code> if this interval contains exactly one single value,
   * <code>false</code> otherwise.
   */
   ...
   * @return <code>true</code> if this interval intersects with the given interval,
   * <code>false</code> otherwise.
   */
