 ...
 */
public class ReplaceVisitor<T> implements NumeralFormulaVisitor<T, NumeralFormula<T>>,
  ...
  private ReplaceVisitor(
    ...
    this.recursiveBooleanFormulaVisitor =
        new RecursiveBooleanFormulaVisitor<T>(this.recursiveNumeralFormulaVisitor) {
