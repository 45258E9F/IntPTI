...
public class CompoundIntervalFormulaManager {
  ...
  private boolean isDefinitelyTrue(BooleanFormula<CompoundInterval> pFormula) {
    return BooleanConstant.isTrue(pFormula)
        || definitelyImplies(Collections.<BooleanFormula<CompoundInterval>>singleton(
        BooleanConstant.<CompoundInterval>getTrue()), pFormula);
  }
  ...
  public boolean definitelyImplies(
    ...
    return definitelyImplies(pFormulas, pFormula,
        new HashMap<MemoryLocation, NumeralFormula<CompoundInterval>>());
  }
  ...
  public boolean definitelyImplies(
    ...
    if (pFormula instanceof Collection<?>) {
      return definitelyImplies((Collection<BooleanFormula<CompoundInterval>>) pFormulas, pFormula,
          true, newMap, false);
    }
   ...
   *                                    extended by splitting the formulas into their conjunctive
   *                                    parts.
   * @param pInformationBaseEnvironment the information base as an environment.
   * @param pEnvironmentComplete        whether or not the environment already contains all
   *                                    information that can be gained from the formulas information
   *                                    base.
  ...
  private boolean definitelyImplies(
    ...
    NonRecursiveEnvironment.Builder tmpEnvironment = NonRecursiveEnvironment.Builder
        .of(compoundIntervalManagerFactory, pInformationBaseEnvironment);
    PushAssumptionToEnvironmentVisitor patev =
        new PushAssumptionToEnvironmentVisitor(compoundIntervalManagerFactory, evaluationVisitor,
            tmpEnvironment);
  ...
  public boolean definitelyImplies(
    ...
    return definitelyImplies(Collections.<BooleanFormula<CompoundInterval>>emptyList(),
        pCompleteEnvironment, pFormula);
  }
      ...
      if (!pExtendedFormulas.contains(formulaAtom)) {
        ...
        if (disjunctions.size() > 1) {
          for (BooleanFormula<CompoundInterval> disjunctionPart : disjunctions) {
            if (definitelyImplies(pExtendedFormulas, disjunctionPart, false, pCompleteEnvironment,
                true)) {
              continue outer;
            }
          }
        ...
        BooleanConstant<CompoundInterval> evaluated =
            pFormula.accept(evaluationVisitor, pCompleteEnvironment);
        ...
        BooleanFormula<CompoundInterval> resolved =
            formulaAtom.accept(variableResolver, evaluationVisitor);

        StateEqualsVisitor stateEqualsVisitor =
            new StateEqualsVisitor(evaluationVisitor, pCompleteEnvironment,
        ...
        if (resolved instanceof Equal) {
          ...
          CompoundIntervalManager cim =
              compoundIntervalManagerFactory.createCompoundIntervalManager(op1.getBitVectorInfo());
          ...
          if (negated instanceof Equal) {
            ...
            CompoundIntervalManager cim = compoundIntervalManagerFactory
                .createCompoundIntervalManager(op1.getBitVectorInfo());
            CompoundInterval leftEval = op1.accept(evaluationVisitor, pCompleteEnvironment);
            CompoundInterval rightEval = op2.accept(evaluationVisitor, pCompleteEnvironment);
            if (!cim.doIntersect(leftEval, rightEval)) {
              continue;
        ...
        if (!pCompleteEnvironment.isEmpty() && formulaAtom.accept(CONTAINS_ONLY_ENV_INFO_VISITOR)) {
          ...
          PushAssumptionToEnvironmentVisitor patev =
              new PushAssumptionToEnvironmentVisitor(compoundIntervalManagerFactory,
                  evaluationVisitor, impliedEnvironment);
          ...
          for (MemoryLocation memoryLocation : memoryLocations) {
            ...
            if (rightFormula instanceof Constant) {
              ...
              CompoundInterval leftValue = leftFormula == null ? cim.allPossibleValues()
                                                               : leftFormula
                                               .accept(evaluationVisitor, pCompleteEnvironment);
              CompoundInterval rightValue =
                  rightFormula.accept(evaluationVisitor, impliedEnvironment);
  ...
  public boolean definitelyImplies(
    ...
    if (pFormula1 instanceof Equal<?> && pFormula2 instanceof Equal<?>) {
      ...
      } else if (p1.getOperand2() instanceof Variable<?> && p1
          .getOperand1() instanceof Constant<?>) {
    ...
    return definitelyImplies(leftFormulas, pFormula2, false,
        new HashMap<MemoryLocation, NumeralFormula<CompoundInterval>>(), false);
  }
  ...
  public NumeralFormula<CompoundInterval> add(
      NumeralFormula<CompoundInterval> pSummand1,
      NumeralFormula<CompoundInterval> pSummand2) {
  ...
  public NumeralFormula<CompoundInterval> binaryAnd(
      NumeralFormula<CompoundInterval> pOperand1,
  ...
  public NumeralFormula<CompoundInterval> divide(
      NumeralFormula<CompoundInterval> pNumerator,
      NumeralFormula<CompoundInterval> pDenominator) {
  ...
  public BooleanFormula<CompoundInterval> equal(
    ...
    if (pOperand1 instanceof Union<?>) {
      ...
      return logicalOr(equal(union.getOperand1(), pOperand2),
          equal(union.getOperand2(), pOperand2));
    }
    if (pOperand2 instanceof Union<?>) {
      Union<CompoundInterval> union = (Union<CompoundInterval>) pOperand2;
      return logicalOr(equal(pOperand1, union.getOperand1()),
          equal(pOperand1, union.getOperand2()));
    }
  ...
  public BooleanFormula<CompoundInterval> lessThan(
    ...
    if (pOperand1 instanceof Union<?>) {
      Union<CompoundInterval> union = (Union<CompoundInterval>) pOperand1;
      return logicalOr(lessThan(union.getOperand1(), pOperand2),
          lessThan(union.getOperand2(), pOperand2));
    }
    if (pOperand2 instanceof Union<?>) {
      Union<CompoundInterval> union = (Union<CompoundInterval>) pOperand2;
      return logicalOr(lessThan(pOperand1, union.getOperand1()),
          lessThan(pOperand1, union.getOperand2()));
    }
  ...
  public BooleanFormula<CompoundInterval> lessThanOrEqual(
    ...
    if (pOperand1 instanceof Union<?>) {
      Union<CompoundInterval> union = (Union<CompoundInterval>) pOperand1;
      return logicalOr(lessThanOrEqual(union.getOperand1(), pOperand2),
          lessThanOrEqual(union.getOperand2(), pOperand2));
    }
    if (pOperand2 instanceof Union<?>) {
      Union<CompoundInterval> union = (Union<CompoundInterval>) pOperand2;
      return logicalOr(lessThanOrEqual(pOperand1, union.getOperand1()),
  ...
  public BooleanFormula<CompoundInterval> logicalAnd(
      BooleanFormula<CompoundInterval> pOperand1,
      BooleanFormula<CompoundInterval> pOperand2) {
      ...
      if (var != null && value != null) {
        ...
        if (otherValue != null) {
          ...
          if (newValue instanceof Union<?>) {
            ...
            useNewValue =
                !(op1.equals(value) && op2.equals(otherValue) || op1.equals(otherValue) && op2
                    .equals(value));
          }
          if (useNewValue) {
  ...
  public NumeralFormula<CompoundInterval> multiply(
      NumeralFormula<CompoundInterval> pFactor1,
  ...
  public NumeralFormula<CompoundInterval> negate(NumeralFormula<CompoundInterval> pToNegate) {
    ...
    if (pToNegate instanceof Constant) {
      return asConstant(bitVectorInfo,
          cim.negate(((Constant<CompoundInterval>) pToNegate).getValue()));
    }
  ...
  public NumeralFormula<CompoundInterval> subtract(
      NumeralFormula<CompoundInterval> pMinuend,
  ...
  public NumeralFormula<CompoundInterval> shiftLeft(
      NumeralFormula<CompoundInterval> pToShift,
  ...
  private NumeralFormula<CompoundInterval> unionAll(
    ...
    if (!pConstantPart.isBottom()) {
      NumeralFormula<CompoundInterval> constantPartFormula =
          asConstant(pBitVectorInfo, pConstantPart);
  ...
  public NumeralFormula<CompoundInterval> fromBoolean(
    ...
    NumeralFormula<CompoundInterval> trueNumeralFormula =
        asConstant(pBitVectorInfo, cim.singleton(BigInteger.ONE));
    NumeralFormula<CompoundInterval> falseNumeralFormula =
        asConstant(pBitVectorInfo, cim.logicalFalse());
    return ifThenElse(
        pFormula,
        trueNumeralFormula,
        falseNumeralFormula);
  ...
  public BooleanFormula<CompoundInterval> fromNumeral(NumeralFormula<CompoundInterval> pFormula) {
    ...
    if (pFormula instanceof IfThenElse) {
      ...
      if (isDefinitelyTrue(ifThenElse.getPositiveCase()) && isDefinitelyFalse(
          ifThenElse.getNegativeCase())) {
        return ifThenElse.getCondition();
      }
      if (isDefinitelyFalse(ifThenElse.getPositiveCase()) && isDefinitelyTrue(
          ifThenElse.getNegativeCase())) {
  ...
  public NumeralFormula<CompoundInterval> cast(
      BitVectorInfo pBitVectorInfo,
      NumeralFormula<CompoundInterval> pToCast) {
    if (pToCast.getBitVectorInfo().equals(pBitVectorInfo)) {
      return pToCast;
    }
    NumeralFormula<CompoundInterval> casted =
        InvariantsFormulaManager.INSTANCE.cast(pBitVectorInfo, pToCast);
  ...
  private NumeralFormula<CompoundInterval> allPossibleValues(BitVectorInfo pBitVectorInfo) {
    return asConstant(pBitVectorInfo,
        getCompoundIntervalManager(pBitVectorInfo).allPossibleValues());
  }
  ...
  private NumeralFormula<CompoundInterval> asConstant(
      BitVectorInfo pBitVectorInfo,
      CompoundInterval pValue) {
