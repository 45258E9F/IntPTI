...
public class FormulaDepthCountVisitor<ConstantType>
  ...
  public Integer visit(ShiftLeft<ConstantType> pShiftLeft) {
    return
        Math.max(pShiftLeft.getShifted().accept(this), pShiftLeft.getShiftDistance().accept(this))
            + 1;
  }
  ...
  public Integer visit(ShiftRight<ConstantType> pShiftRight) {
    return
        Math.max(pShiftRight.getShifted().accept(this), pShiftRight.getShiftDistance().accept(this))
            + 1;
  }
