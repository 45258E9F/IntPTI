...
public enum InvariantsFormulaManager {
   ...
   */
  public <T> NumeralFormula<T> divide(
      NumeralFormula<T> pNumerator,
      NumeralFormula<T> pDenominator) {
   ...
   */
  public <T> BooleanFormula<T> greaterThan(
      NumeralFormula<T> pOperand1,
   ...
   * operands.
   */
  public <T> BooleanFormula<T> greaterThanOrEqual(
      NumeralFormula<T> pOperand1,
      NumeralFormula<T> pOperand2) {
   ...
   * operands.
   */
  public <T> BooleanFormula<T> lessThanOrEqual(
      NumeralFormula<T> pOperand1,
      NumeralFormula<T> pOperand2) {
   ...
   */
  public <T> BooleanFormula<T> logicalAnd(
      BooleanFormula<T> pOperand1,
      BooleanFormula<T> pOperand2) {
   ...
   */
  public <T> BooleanFormula<T> logicalImplies(
      BooleanFormula<T> pOperand1,
      BooleanFormula<T> pOperand2) {
   ...
   */
  public <T> NumeralFormula<T> modulo(
      NumeralFormula<T> pNumerator,
      NumeralFormula<T> pDenominator) {
   ...
   */
  public <T> NumeralFormula<T> multiply(
      NumeralFormula<T> pFactor1,
   ...
   */
  public <T> NumeralFormula<T> shiftLeft(
      NumeralFormula<T> pToShift,
   ...
   * second given operand.
   */
  public <T> NumeralFormula<T> shiftRight(
      NumeralFormula<T> pToShift,
      NumeralFormula<T> pShiftDistance) {
   ...
   */
  public <T> NumeralFormula<T> union(
      NumeralFormula<T> pOperand1,
      NumeralFormula<T> pOperand2) {
   ...
   * @return a numeral formula representing an if-then-else condition-dependent value.
   */
   ...
   * @return an invariants formula representing the cast of the given operand to the given bit
   * vector.
   */
