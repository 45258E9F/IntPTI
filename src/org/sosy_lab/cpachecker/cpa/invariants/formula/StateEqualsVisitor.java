 ...
 */
public class StateEqualsVisitor extends
                                DefaultParameterizedNumeralFormulaVisitor<CompoundInterval, NumeralFormula<CompoundInterval>, Boolean>
    implements
    ParameterizedBooleanFormulaVisitor<CompoundInterval, BooleanFormula<CompoundInterval>, Boolean> {
   ...
   * @param pEnvironment       the environment providing the context for the analysis of state
   *                           equality.
   */
  ...
  protected Boolean visitDefault(
      ...
      NumeralFormula<CompoundInterval> pOther) {
  ...
  private Boolean visitDefault(
      ...
      BooleanFormula<CompoundInterval> pOther) {
   ...
   * @return <code>true</code> if both formulae definitely represent equal states,
   * <code>false</code> if the represented states are not equal or their equality could not be
   * determined.
   */
  ...
  public Boolean visit(
    ...
    CompoundIntervalManager cim =
        compoundIntervalManagerFactory.createCompoundIntervalManager(pVariable.getBitVectorInfo());
