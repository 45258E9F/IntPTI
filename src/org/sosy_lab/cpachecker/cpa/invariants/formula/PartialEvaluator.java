...
public class PartialEvaluator implements
  ...
  public PartialEvaluator(CompoundIntervalManagerFactory pCompoundIntervalManagerFactory) {
    this(pCompoundIntervalManagerFactory,
  ...
  private NumeralFormula<CompoundInterval> singleton(
      BitVectorType pBitVectorType,
      BigInteger pValue) {
  ...
  public NumeralFormula<CompoundInterval> visit(
    ...
    while (!unionParts.isEmpty()) {
      ...
      if (currentPart instanceof Union<?>) {
        ...
        constantPart = compoundIntervalManager
            .union(constantPart, ((Constant<CompoundInterval>) currentPart).getValue());
      } else {
    ...
    if (partsFound > atomicUnionParts.size()) {
      ...
      if (!constantPart.isBottom()) {
        ...
        result = result == null ? constantPartFormula
