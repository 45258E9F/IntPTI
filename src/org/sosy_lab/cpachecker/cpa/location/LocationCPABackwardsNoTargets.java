...
public class LocationCPABackwardsNoTargets implements ConfigurableProgramAnalysis {
  ...
  public LocationCPABackwardsNoTargets(CFA pCfa, Configuration pConfig)
      throws InvalidConfigurationException {
    stateFactory = new LocationStateFactory(pCfa, LocationStateType.BACKWARD_NO_TARGET, pConfig);
    transferRelation = new LocationTransferRelationBackwards(stateFactory);
  }

  public static CPAFactory factory() {
    return new LocationCPAFactory(LocationStateType.BACKWARD_NO_TARGET);
  }
