...
public class NameProvider {
  ...
  public String getObjectScope(
      RTTState rttState, String methodName,
  ...
  public String getScopedVariableName(
      String pVariableName, String pFunctionName, String pUniqueObject,
      RTTState pState) {
  ...
  public String getScopedVariableName(
    ...
    if (pDeclaration instanceof JFieldDeclaration && ((JFieldDeclaration) pDeclaration)
        .isStatic()) {
      return variableName;
