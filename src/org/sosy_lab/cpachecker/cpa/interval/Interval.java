...
public class Interval implements Serializable {
   ...
   * another interval.
   *
   * The lower bound and upper bound of the new interval is the minimum of both lower bounds and the
   * maximum of both upper bounds, respectively.
   *
   ...
   * another interval.
   *
   * The lower bound and upper bound of the new interval is the maximum of both lower bounds and the
   * minimum of both upper bounds, respectively.
   *
   * @param other the other interval
   * @return the new interval with the respective bounds
   */
   ...
   * maximum of this interval's and the other interval's lower bound or an empty interval if this
   * interval is less than the other interval.
   */
   ...
   * minimum of this interval's and the other interval's upper bound or an empty interval if this
   * interval is greater than the other interval.
   */
   ...
   *
   * The method still returns true, if the borders match. An empty interval does not contain any
  ...
  public Interval times(Interval other) {
    ...
    return new Interval(Collections.min(Arrays.asList(values)),
   ...
   *
   * @return an unbounded interval, i.e. the lower and upper bound are set to Long.MIN_VALUE and
