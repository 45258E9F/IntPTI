...
public class AssignmentsInPathCondition implements PathCondition, Statistics {
  ...
  @Option(secure = true, description =
      "determines if there should be one single assignment state per state,"
  ...
  public AvoidanceReportingState getAbstractSuccessor(AbstractState pElement, CFAEdge pEdge) {
    ...
    if (scope == Scope.STATE
      ...
      return new UniqueAssignmentsInPathConditionState(current.maximum,
  ...
  public class UniqueAssignmentsInPathConditionState
    ...
    private UniqueAssignmentsInPathConditionState(
        int pMaximum,
        Multimap<MemoryLocation, Value> pMapping) {
      maximum = pMaximum;
      mapping = pMapping;
    }
    ...
    @Override
    public int hashCode() {
      return Objects.hashCode(mapping, maximum);
    }
    ...
    public boolean equals(Object obj) {
      ...
      if (obj == null || !(obj instanceof UniqueAssignmentsInPathConditionState)) {
        return false;
      }
      UniqueAssignmentsInPathConditionState that = (UniqueAssignmentsInPathConditionState) obj;
      return Objects.equal(mapping, that.mapping) && Objects.equal(maximum, that.maximum);
    }
