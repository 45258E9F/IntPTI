...
class GlobalConditionsSimplePrecisionAdjustment extends SimplePrecisionAdjustment {
  ...
  private boolean checkProcessMemory() {
    ...
    try {
      ...
      logger.log(Level.WARNING,
          "Your Java VM does not support measuring the memory size, process memory threshold disabled");
    ...
    if (!(memUsedObject instanceof Long)) {
      logger.log(Level.WARNING, "Invalid value received for memory size: " + memUsedObject
