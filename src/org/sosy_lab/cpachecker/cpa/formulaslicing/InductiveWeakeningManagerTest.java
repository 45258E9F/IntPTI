...
public class InductiveWeakeningManagerTest {
  ...
  @Test
  public void slicingSimpleRearranged() throws Exception {
  ...
  @Test
  public void testSlicingComplex() throws Exception {
    CFA cfa = toCFA(
        "int x, y, p, nondet;",
        "x = 5;",
        "y = 10;",
  ...
  private PathFormula toPathFormula(PathFormulaManager pfmgr, CFA cfa, SSAMap initialSSA)
      throws Exception {
