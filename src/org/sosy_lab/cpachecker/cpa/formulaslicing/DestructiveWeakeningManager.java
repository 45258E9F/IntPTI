...
public class DestructiveWeakeningManager {
   ...
   *
   * @param selectionInfo Mapping from selection variables to the atoms (possibly w/ negation) they
   *                      represent.
   * @param selectionVars List of selection variables, already determined to be inductive. The order
   *                      is very important and determines which MUS we will get out.
