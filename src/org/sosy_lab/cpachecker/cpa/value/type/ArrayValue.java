...
public class ArrayValue implements Value {
   ...
   * </p>
   *
   * @param pType      the type of the array. Only values of this type's element type or subtypes of
   *                   this type's element type can be stored in the returned
   *                   <code>ArrayValue</code> object
   ...
   *
   * @param pType   the type of the array. Only values of this type's element type or subtypes of
   *                this type's element type can be stored in the returned <code>ArrayValue</code>
   *                object
