...
public class BooleanValue implements Value {
   ...
   * <code>BooleanValue</code> object representing the boolean meaning of the given value, if one
   ...
   * value.
   *
   * @return <p>Returns a <code>NumericValue</code> object with value <code>1</code>, if this
   * object's value is <code>true</code>. Returns an object with value <code>0</code> otherwise.
   */
  @Override
