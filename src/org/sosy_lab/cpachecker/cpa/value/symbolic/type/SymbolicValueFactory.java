...
public class SymbolicValueFactory {
  ...
  public SymbolicExpression multiply(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new MultiplicationExpression(pOperand1, pOperand2, getCanonicalType(pType),
  ...
  public SymbolicExpression add(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new AdditionExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression minus(
    ...
    return new SubtractionExpression(pOperand1, pOperand2, getCanonicalType(pType),
        canonicalCalcType);
  }
  ...
  public SymbolicExpression divide(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new DivisionExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  ...
  public SymbolicExpression modulo(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new ModuloExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression shiftLeft(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new ShiftLeftExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression shiftRightSigned(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new ShiftRightExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType),
  ...
  public SymbolicExpression binaryAnd(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new BinaryAndExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression binaryOr(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new BinaryOrExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression binaryXor(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new BinaryXorExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public EqualsExpression equal(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new EqualsExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression lessThan(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new LessThanExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression lessThanOrEqual(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2,
      Type pType, Type pCalculationType) {
    return new LessThanOrEqualExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression logicalAnd(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new LogicalAndExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression logicalOr(
      SymbolicExpression pOperand1, SymbolicExpression pOperand2, Type pType,
      Type pCalculationType) {
    return new LogicalOrExpression(pOperand1, pOperand2, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression greaterThan(
    ...
    return new LessThanExpression(pOperand2, pOperand1, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
  ...
  public SymbolicExpression greaterThanOrEqual(
    ...
    // represent 'a >= b' as 'b <= a' so we do need less classes
    return new LessThanOrEqualExpression(pOperand2, pOperand1, getCanonicalType(pType),
        getCanonicalType(pCalculationType));
  }
