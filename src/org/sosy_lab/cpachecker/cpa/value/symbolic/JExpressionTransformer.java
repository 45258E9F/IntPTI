...
public class JExpressionTransformer extends ExpressionTransformer
  ...
  public SymbolicExpression visit(JBinaryExpression paBinaryExpression)
    ...
    switch (operator) {
      ...
      case MINUS:
        return factory
            .minus(operand1Expression, operand2Expression, expressionType, expressionType);
      case MULTIPLY:
        return factory
            .multiply(operand1Expression, operand2Expression, expressionType, expressionType);
      case DIVIDE:
        return factory
            .divide(operand1Expression, operand2Expression, expressionType, expressionType);
      case MODULO:
        return factory
            .modulo(operand1Expression, operand2Expression, expressionType, expressionType);
      case SHIFT_LEFT:
        return factory
            .shiftLeft(operand1Expression, operand2Expression, expressionType, expressionType);
      case SHIFT_RIGHT_SIGNED:
        return factory.shiftRightSigned(operand1Expression, operand2Expression, expressionType,
            expressionType);
      case SHIFT_RIGHT_UNSIGNED:
        return factory.shiftRightUnsigned(operand1Expression, operand2Expression, expressionType,
            expressionType);
      case BINARY_AND:
        return factory
            .binaryAnd(operand1Expression, operand2Expression, expressionType, expressionType);
      case BINARY_OR:
        return factory
            .binaryOr(operand1Expression, operand2Expression, expressionType, expressionType);
      case BINARY_XOR:
        return factory
            .binaryXor(operand1Expression, operand2Expression, expressionType, expressionType);
      case EQUALS:
        return factory
            .equal(operand1Expression, operand2Expression, expressionType, expressionType);
      case NOT_EQUALS:
        return factory
            .notEqual(operand1Expression, operand2Expression, expressionType, expressionType);
      case LESS_THAN:
        return factory
            .lessThan(operand1Expression, operand2Expression, expressionType, expressionType);
      case LESS_EQUAL:
        return factory.lessThanOrEqual(operand1Expression, operand2Expression, expressionType,
            expressionType);
      case GREATER_THAN:
        return factory
            .greaterThan(operand1Expression, operand2Expression, expressionType, expressionType);
      case GREATER_EQUAL:
      ...
      case CONDITIONAL_AND:
        return factory
            .logicalAnd(operand1Expression, operand2Expression, expressionType, expressionType);
      case LOGICAL_OR:
      case CONDITIONAL_OR:
        return factory
            .logicalOr(operand1Expression, operand2Expression, expressionType, expressionType);
      case LOGICAL_XOR:
        return factory
            .binaryXor(operand1Expression, operand2Expression, expressionType, expressionType);
      default:
