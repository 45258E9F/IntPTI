...
public class RealAliasCreator implements AliasCreator {
   ...
   * @return <code>null</code> if the two expressions can't be aliases in the given environment, a
   * new environment in which the two expressions are aliases, otherwise
   */
