...
public class PredicateManager {
  ...
  public PredicateManager(
      final Configuration config, final NamedRegionManager pRmgr,
  ...
  protected void initVars(CFA cfa) {
    ...
    for (VariableClassification.Partition partition : partitions) {
      ...
      createPredicates(partition.getVars(),
   ...
   */
  protected Region[] createPredicate(
    ...
    if (precision != null && !precision
        .isTracking(MemoryLocation.valueOf(varName), varType, location)) {
      return null;
    }
