...
public class BDDVectorCExpressionVisitor
  ...
  protected BDDVectorCExpressionVisitor(
      final PredicateManager pPredMgr, final VariableTrackingPrecision pPrecision,
  ...
  public static Region[] calculateBinaryOperation(
      Region[] lVal, Region[] rVal, final BitvectorManager bvmgr,
  ...
  private static Region[] arithmeticOperation(
      final Region[] l, final Region[] r, final BitvectorManager bvmgr,
  ...
  public Region[] visit(CIdExpression idExp) {
    ...
    return predMgr
        .createPredicate(idExp.getDeclaration().getQualifiedName(), idExp.getExpressionType(),
            location, getSize(idExp.getExpressionType()), precision);
  }
  ...
  public static Region[] castCValue(
      @Nullable final Region[] value, final CType targetType,
